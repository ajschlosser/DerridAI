"""Deterministic-first segmentation: candidates, routing, budgets (release 0.40.9, "Enter Sandman").
...
Note: some test names mention v6/v8 from the release they were written for; they now
assert against the current profile (derrida-scholarly-v12).
"""
