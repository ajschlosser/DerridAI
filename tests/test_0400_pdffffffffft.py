...
def test_0400_release_identity_and_notes():
    ...
    assert 'version="0.50.0"' in text("api/app/main.py")
    assert 'APP_VERSION = "0.50.0"' in text("api/app/config.py")
    assert "# DerridAI Corpus Viewer 0.50.0" in text("README.md")
