...
def test_0405_release_identity_and_name():
    ...
    assert 'version="0.48.0"' in text("api/app/main.py")
    assert 'APP_VERSION = "0.48.0"' in text("api/app/config.py")
...
def test_0405_new_semantic_pipeline_is_provenance_versioned():
    ...
    assert 'METADATA_PROMPT_VERSION = "derridai-record-metadata-v7"' in builder
