...
| Authentication, roles, researcher policy | `test_roles_and_rag_request_validation`, `test_researcher_profile_generation_options`, `test_auth_hardening`, `test_researcher_rag_profile`, `test_researcher_text_policy`, `test_content_filter_false_positives` |
