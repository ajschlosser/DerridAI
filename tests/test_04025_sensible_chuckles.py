...
def test_new_builds_start_unpublished_and_storybook_uses_snapshot_semantics(tmp_path:Path):
    ...
    assert 'ReadyToPublish' in stepper and 'Published' in stepper and 'ResolveExceptions' in stepper
