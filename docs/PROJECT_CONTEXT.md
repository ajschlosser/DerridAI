...
Preprocessing must be conservative. Do not strip stopwords or normalize aggressively; words such as *not, without, if, perhaps, only, as if* can determine the proposition. Take particular care with punctuation, quotation marks, emphasis, capitalization, proper names, French/Greek/German terms, and Derridean coinages.
