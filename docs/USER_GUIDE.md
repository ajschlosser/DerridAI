...
To repopulate records built before this behavior existed, retry metadata enrichment on the build (or rebuild); already-enriched records are not changed automatically.
