...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.pause': 'Mettre en pause',
 'pdf_corpus.pause_requested': 'Mise en pause demandée. La construction reprendra au dernier point de contrôle sûr.',
 'language.template_reference': 'Paramètres de modèle',
 'language.template_reference_help': 'Ces paramètres sont repérés dans le dictionnaire canonique et résolus par l’écran qui affiche chaque message.',
 'language.template_count': 'un nombre localisé',
 'language.template_holder': 'le titulaire des droits configuré',
 'language.template_year': 'l’année courante des droits',
 'language.template_runtime': 'la valeur fournie par l’écran appelant ({name})',
