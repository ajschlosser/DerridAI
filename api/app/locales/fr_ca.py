...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.assign_selected_evidence': 'Utiliser le texte sélectionné comme preuve',
 'pdf_corpus.assign_selected_evidence_help': 'Sélectionnez le texte justificatif dans la fiche, puis associez à cette valeur de métadonnée le segment source correspondant le plus proche.',
