...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'works.edit_metadata_apply_help': 'Cochez Appliquer uniquement pour les champs à modifier dans toutes les fiches associées. Changer l’œuvre renomme l’œuvre pour toutes les fiches chargées. Chaque champ modifié est consigné dans l’historique updates de chaque fiche.',
