...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'runtime.system_data_help': "Gérez la mémoire cache des réponses et les bases de données durables de l’application au moyen d’une interface sûre et indépendante du moteur.",
