...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.enrich_metrics.next_work': 'Ce qui attend encore une personne',
 'pdf_corpus.enrich_metrics.verdict_trust': 'Confiance',
 'pdf_corpus.enrich_metrics.verdict_grounding': 'Ancrage',
 'pdf_corpus.enrich_metrics.verdict_effort': 'Effort',
 'pdf_corpus.enrich_metrics.verdict_sample': '{reviews} révisées sur {proposed} proposées',
 'pdf_corpus.enrich_metrics.sparse_note': 'Toutes les mesures restent dans les tableaux ci-dessous, y compris les cellules qui indiquent encore des données insuffisantes.',
 'pdf_corpus.enrichment_pass_added_label': 'ajoutées',
 'pdf_corpus.enrichment_pass_replaced_label': 'remplacées',
 'pdf_corpus.enrichment_pass_kept_label': 'conservées',
 'pdf_corpus.enrichment_pass_disputed_label': 'désaccords',
