...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.gutenberg_redownload': 'Télécharger de nouveau',
 'pdf_corpus.gutenberg_redownload_confirm': 'Supprimer la collection téléchargée ({size}) et la télécharger de nouveau depuis le début?',
 'pdf_corpus.record_sizing.characters_help': 'Les tailles sont en caractères, espaces et ponctuation compris (les « caractères espaces compris » d’un traitement de texte). En anglais et en français, un mot compte en moyenne environ 6 caractères : 250 caractères font environ 40 mots.',
 'pdf_corpus.record_sizing.characters_help_label': 'Comment la taille des fiches est comptée',
 'pdf_corpus.record_sizing.about_words': 'environ {count} mots',
 'pdf_corpus.library.placeholder_gutenberg': 'Titre, auteur ou sujet',
 'pdf_corpus.library.placeholder_wikisource': 'Titre ou auteur',
 'pdf_corpus.library.language_label': 'Édition de Wikisource',
 'pdf_corpus.library.searching': 'Recherche en cours…',
 'pdf_corpus.library.no_results': 'Aucun texte ne correspond à « {query} ».',
 'pdf_corpus.library.results_count': '{count} résultat(s)',
 'pdf_corpus.library.hint_gutenberg': 'Cherchez dans le catalogue du Projet Gutenberg par titre, auteur ou sujet.',
 'pdf_corpus.library.hint_wikisource': 'Recherche sur {host}. Importer une œuvre en apporte tous les chapitres.',
 'pdf_corpus.library.try_examples': 'Essayez',
 'pdf_corpus.library.import': 'Importer',
 'pdf_corpus.library.import_label': 'Importer {title}',
 'pdf_corpus.library.import_work': 'Importer l’œuvre entière',
 'pdf_corpus.library.import_work_label': 'Importer l’œuvre entière : {title}',
 'pdf_corpus.library.import_part': 'Seulement cette partie',
 'pdf_corpus.library.import_part_label': 'Seulement cette partie : {title}',
 ...
 'pdf_corpus.library.collection_needed': 'L’importation depuis le Projet Gutenberg utilise la collection locale. Téléchargez-la une fois ; vous pouvez chercher en attendant.',
 ...
 'pdf_corpus.evidence_selection_hint': 'Sélectionnez le texte justificatif dans la fiche pour le citer.',
 'pdf_corpus.evidence_selection_clear': 'Effacer',
 'pdf_corpus.evidence_choosing_for': 'Preuves pour {field}',
 'pdf_corpus.evidence_span_count_one': '{count} segment',
 'pdf_corpus.evidence_span_count_many': '{count} segments',
 'pdf_corpus.evidence_none_yet': 'Aucune preuve pour l’instant',
 'pdf_corpus.evidence_next_field': 'Prochain champ sans preuve',
 'pdf_corpus.evidence_done': 'Terminé',
 'pdf_corpus.evidence_only_selected': 'Seulement les sélectionnés',
 'pdf_corpus.evidence_filter': 'Chercher dans le texte source',
 'pdf_corpus.evidence_no_match': 'Aucun segment source ne correspond.',
 'pdf_corpus.evidence_use': 'Utiliser comme preuve',
 'pdf_corpus.model_suggested': 'Suggéré par le modèle',
 'pdf_corpus.model_suggested_short': 'Suggéré',
 'pdf_corpus.all_values': 'Toutes les valeurs',
 'pdf_corpus.no_value_short': 'Aucune valeur',
 'pdf_corpus.field_saved_short': 'Enregistré',
 'pdf_corpus.edit_field': 'Modifier {field}',
 'pdf_corpus.required_to_accept': 'Requis pour accepter',
 'pdf_corpus.metadata_review_help_label': 'À propos de la révision des métadonnées',
 'pdf_corpus.dock_metadata_complete': 'Métadonnées décidées',
 'pdf_corpus.dock_record_accepted': 'Fiche acceptée',
 'pdf_corpus.shortcut.confirm_field': 'Ctrl+Entrée',
 ...
 'pdf_corpus.metadata_decisions_count': '{count} décision(s) restante(s)',
 ...
 'pdf_corpus.record_sizing.ruler_label': 'Échelle de longueur des notices : cible de {low} à {high} caractères, jusqu’à {long} au besoin, jamais plus de {absolute}.',
 'pdf_corpus.record_sizing.ruler_target': 'plage cible',
 'pdf_corpus.record_sizing.ruler_exception': 'permis au besoin',
 'pdf_corpus.record_sizing.ruler_ceiling': 'plafond',
 'pdf_corpus.record_sizing.ruler_short': 'plus court que la cible',
 'pdf_corpus.record_sizing.ruler_observed': 'Votre dernière compilation : médiane {median}, la plupart des fiches entre {p10} et {p90}, la plus longue {max} caractères.',
 'pdf_corpus.record_sizing.presets_title': 'Cibles courantes',
 'pdf_corpus.record_sizing.preset_sentence': 'Phrase',
 'pdf_corpus.record_sizing.preset_short': 'Courte',
 'pdf_corpus.record_sizing.preset_paragraph': 'Paragraphe',
 'pdf_corpus.record_sizing.preset_default': 'Par défaut',
 'pdf_corpus.record_sizing.auto': 'Définir automatiquement les limites d’exception',
 'pdf_corpus.record_sizing.auto_help': 'La limite de notice longue et le plafond suivent votre cible : {long} et {absolute} caractères.',
 'pdf_corpus.record_sizing.min_hint': 'Doit être d’au moins {min}.',
 'pdf_corpus.record_sizing.fix': 'Fixer à {min}',
 ...
 'pdf_corpus.units_title': 'Unités sources',
 'pdf_corpus.units_help': 'Une unité source est le plus petit passage auquel une preuve peut renvoyer. Choisissez la finesse de découpage de cette source. Le découpage est déterministe; aucun texte n’est perdu, ajouté ou réordonné.',
 'pdf_corpus.units_unapplied': 'Pas encore appliqué',
 'pdf_corpus.units_mode_default': 'Automatique (recommandé)',
 'pdf_corpus.units_mode_default_help': 'Conserver les paragraphes extraits; tout paragraphe plus long que la taille de fiche longue de la construction est divisé en phrases au lancement, pour que les fiches puissent être aussi courtes que demandé.',
 'pdf_corpus.units_mode_paragraph': 'Chaque paragraphe',
 'pdf_corpus.units_mode_paragraph_help': 'Une unité par paragraphe, jamais divisée : les fiches ne peuvent pas être plus courtes qu’un paragraphe.',
 'pdf_corpus.units_mode_line': 'Chaque ligne',
 'pdf_corpus.units_mode_line_help': 'Une unité par ligne. Convient aux vers, aux dialogues et aux transcriptions.',
 'pdf_corpus.units_mode_sentence': 'Chaque phrase',
 'pdf_corpus.units_mode_sentence_help': 'Une unité par phrase, en tenant compte des abréviations comme M., p. et fig.',
 'pdf_corpus.units_mode_chars': 'Tous les n caractères',
 'pdf_corpus.units_mode_chars_help': 'Fenêtres de taille fixe, coupées aux limites de mots.',
 'pdf_corpus.units_chars_label': 'Caractères par unité',
 'pdf_corpus.units_presets': 'Tailles courantes',
 'pdf_corpus.units_chars_invalid': 'Choisissez entre 60 et 20 000 caractères.',
 'pdf_corpus.units_count': 'Unités',
 'pdf_corpus.units_median': 'Médiane (caractères)',
 'pdf_corpus.units_range': 'Plus courte–plus longue',
 'pdf_corpus.units_sample': 'Premières unités selon ce choix',
 'pdf_corpus.units_loading': 'Calcul des unités…',
 'pdf_corpus.units_apply': 'Utiliser ce découpage',
 'pdf_corpus.units_apply_help': 'Cela crée une nouvelle version de la source avec les unités choisies. L’original reste dans Vos sources.',
 'pdf_corpus.units_applied': 'Source découpée en {count} unités.',
 'pdf_corpus.size_advice_title': 'Votre source est découpée trop grossièrement pour cette longueur de notice',
 'pdf_corpus.size_advice_body': 'Les notices sont construites à partir d’unités sources entières; elles ne peuvent donc pas être plus courtes qu’une unité. Vous avez demandé des notices d’environ {target} caractères, mais les unités de cette source font typiquement {median} caractères (la plus longue en compte {longest}). Découpez la source plus finement pour que la longueur soit respectée.',
 'pdf_corpus.size_advice_sentences': 'Découper en phrases',
 'pdf_corpus.size_advice_chars': 'Découper tous les {n} caractères',
 ...
 'pdf_corpus.source_page_detect_llm': 'Si aucun n’est trouvé, interroger le modèle d’IA',
 'pdf_corpus.source_page_detect_llm_help': 'Le modèle ne fait que désigner des lignes candidates; sa réponse doit tout de même former une suite de pages crédible. Utilise votre fournisseur sélectionné. Désactivez pour rester entièrement déterministe.',
 'pdf_corpus.memory_hints_title': 'Suggéré par des révisions antérieures',
 'pdf_corpus.memory_hint_support': '{count} révisions antérieures',
 'pdf_corpus.derivation_memory': 'Mémoire des métadonnées',
 'pdf_corpus.derivation_nlp': 'Dérivé par TALN',
 'pdf_corpus.derivation_computed': 'Calculé',
 'pdf_corpus.ownership.memory': 'Mémoire des métadonnées',
 'pdf_corpus.ownership.nlp': 'Dérivé par TALN',
 'pdf_corpus.ownership.computed': 'Calculé',
 'pdf_corpus.ownership_help.memory': 'Suggéré par des précédents révisés dont la preuve correspond à ce passage source. Un réviseur doit le confirmer.',
 'pdf_corpus.ownership_help.nlp': 'Proposé par un étiqueteur linguistique statistique. Un réviseur doit le confirmer.',
 'pdf_corpus.ownership_help.computed': 'Calculé à partir d’un motif exact ou d’un calcul. Un réviseur doit le confirmer.',
 ...
 'pdf_corpus.focus_progress_label': 'Progression de la révision',
 'pdf_corpus.focus_progress_summary': '{accepted} acceptées, {remaining} restantes',
 'pdf_corpus.focus_shortcut_decide': 'Accepter · rejeter · à réviser',
 'pdf_corpus.focus_shortcut_history': 'Annuler · rétablir',
 'pdf_corpus.focus_shortcut_queue': 'Suivante · précédente dans la file',
 'pdf_corpus.focus_shortcut_metadata': 'Aller à la prochaine décision de métadonnées ouverte',
