...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.metadata_enrichment_again_help': 'Lancez un autre passage LLM sur les notices existantes. Les notices acceptées demeurent acceptées sauf si le nouveau passage ajoute des métadonnées ou conteste une valeur existante.',
 ...
 'pdf_corpus.enrichment_passes_help': 'Chaque passage tient compte de vos décisions et du passage précédent. L’enchaînement s’arrête dès qu’un passage ne trouve rien de nouveau. Vous pouvez continuer la révision pendant l’exécution.',
