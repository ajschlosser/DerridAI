...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.text_noise.llm_help': 'Facultatif. Le modèle ne peut qu’augmenter le score déterministe. Le texte propre et les notices déjà illisibles sont ignorés.',
