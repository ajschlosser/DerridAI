...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.choose_pdf': 'Choisir une source',
 ...
 'pdf_corpus.open_pdf_first': 'Ouvrez d’abord un PDF dans l’Explorateur, ou choisissez une source ici.',
 ...
 'pdf_corpus.source_illegibility': 'Lire un numérisé difficile',
 'pdf_corpus.source_illegibility_help': 'Laissez 0 lorsque le fichier contient déjà du texte, comme un PDF normal, un document Word ou une page Web. Montez le curseur seulement pour une image de page. Plus la valeur est haute, plus DerridAI lit la page par OCR au lieu du texte déjà dans le fichier. Ce n’est pas le seuil de bruit utilisé plus tard à la révision.',
 'pdf_corpus.source_illegibility_value': '{value} sur 100. 0 utilise le texte déjà dans le fichier. 100 lit un numérisé difficile par OCR.',
 'pdf_corpus.reading_source': 'Lecture de la source…',
 'pdf_corpus.searching_gutenberg': 'Recherche dans le Projet Gutenberg…',
 ...
 'pdf_corpus.title': 'Créer des fiches auditables à partir de documents sources',
