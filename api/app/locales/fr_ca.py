...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'works.mixed': 'Mixte',
 'works.title': 'Œuvres',
 'works.page_help': 'Organisez, inspectez et synchronisez les œuvres de votre corpus savant.',
 'works.title_count': 'œuvres',
 'works.toolbar': 'Commandes de la bibliothèque d’œuvres',
 'works.library': 'Bibliothèque d’œuvres',
 'works.no_matches': 'Aucune œuvre ne correspond à cette recherche',
 'works.no_matches_help': 'Essayez un autre titre ou effacez le filtre.',
 'works.no_works': 'Aucune œuvre n’est encore chargée',
 'works.selected_work': 'Œuvre sélectionnée',
 'works.selected_summary': '{records} notices dans {files} fichiers sources',
 'works.synced': 'Synchronisée',
 'works.pending_changes': 'Modifications en attente',
 'works.in_database': 'Dans la base de données',
 'works.not_in_database': 'Absente de la base de données',
 'works.no_database': 'Aucune base de données',
 'works.status_loading': 'Vérification de l’état',
