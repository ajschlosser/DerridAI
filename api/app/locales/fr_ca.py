...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'schemas.field_role_help': 'Le rôle décrit comment DerridAI utilise ce champ indépendamment de son nom de stockage. Les champs savants sont des métadonnées de recherche; les champs structurels décrivent la structure du corpus; les champs documentaires décrivent l’édition source; les champs opérationnels contiennent des données utilitaires ou d’exécution.',
 'schemas.role_scholarly': 'Métadonnées savantes',
 'schemas.role_structural': 'Métadonnées structurelles',
 'schemas.role_document': 'Métadonnées documentaires',
 'schemas.role_operational': 'Opérationnel / utilitaire',
 'schemas.review_visibility': 'Visibilité dans la révision des notices',
 'schemas.review_visibility_help': 'Détermine si ce champ apparaît dans la révision ordinaire des notices. Les champs masqués restent disponibles dans le modèle de données sans être présentés comme métadonnées savantes.',
 ...
 'traceability.application_link': 'Lien DerridAI',
 'traceability.connections': 'Connexions',
 'traceability.empty': 'Aucune relation de traçabilité n’est encore disponible pour cet objet.',
 'traceability.help': 'Sélectionnez n’importe quel objet connecté pour en faire le nouveau point focal. Votre parcours constitue un historique, pas une limite du graphe.',
 'traceability.instance': 'Instance',
 'traceability.kicker': 'Graphe des objets de recherche',
 'traceability.loading': 'Chargement de la traçabilité…',
 ...
 'traceability.mode': 'Mode du graphe',
 'traceability.model': 'Modèle',
 'traceability.no_connections': 'Aucun objet connecté n’est conservé depuis ce point focal.',
 'traceability.open': 'Ouvrir',
 'traceability.title': 'Traçabilité',
 'traceability.walk_history': 'Historique de parcours',
 'traceability.walk_to': 'Aller à',
 ...
 'pdf_corpus.assertion_revision': 'Révision de la notice',
 ...
 'pdf_corpus.run_monitor': 'Moniteur d’exécution',
