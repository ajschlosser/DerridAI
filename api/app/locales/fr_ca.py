...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.units_mode_default': 'Tel qu’extrait',
 'pdf_corpus.units_mode_default_help': 'Conserver les unités de l’extracteur : paragraphes pour la prose, blocs de mise en page pour les PDF.',
 'pdf_corpus.units_mode_paragraph': 'Chaque paragraphe',
 'pdf_corpus.units_mode_paragraph_help': 'Une unité par paragraphe.',
