...
FR_CA: dict[str, str] = {'annotations.add_note': 'Ajouter une note',
 ...
 'pdf_corpus.source_illegibility': 'Illisibilité de la source',
 'pdf_corpus.source_illegibility_help': 'Réglez ce curseur avant de choisir un fichier. Une valeur plus élevée force l’OCR lorsque la source est difficile à lire.',
 ...
 'pdf_corpus.source_illegibility_value': '{value} sur 100. Une valeur plus élevée reconnaît davantage le texte par OCR.',
 'pdf_corpus.url_placeholder': 'https://',
 'pdf_corpus.gutenberg_results': 'Résultats du Projet Gutenberg',
 'pdf_corpus.import_gutenberg_hit': 'Charger {title} de {author}',
