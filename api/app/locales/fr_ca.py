...
FR_CA: dict[str, str] = {'common.apply': 'Appliquer',
 ...
 'pdf_corpus.model_loading_slow': 'Cela prend plus de temps que d’habitude. Si cela ne se termine pas, redémarrez Ollama et annulez les autres constructions qui l’attendent ; elles partagent son unique chargement de modèle.',
