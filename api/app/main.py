...
def import_pdf_asset_url(body: PdfSourceUrlImport):
    try:
...
def search_gutenberg_texts(q: str = Query(default="", max_length=200), limit: int = Query(default=12, ge=1, le=30)):
    try:
...
def import_gutenberg_text(body: GutenbergImport):
    try:
