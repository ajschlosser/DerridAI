...
"""Normalization helpers for persisted LLM provider profiles."""
...
def profile_generation_options(
    profile: dict[str, object],
) -> dict[str, object]:
    """Normalize persisted provider controls for typed generation requests.

    Provider profiles predate the current typed request models, so optional
    values may still be stored as strings. Invalid optional values are omitted
    instead of being guessed or forwarded with the wrong type.
    """
