...
# 0.43.0 — Crocodile: integrated record + metadata review.
DEFAULT_EN_US.update({
...
DEFAULT_EN_US.update({'field.__db_status': 'DB status',
 ...
 'legacy.open_in_faq': 'Open in Response Library',
 ...
 'legacy.response_faq': 'Response Library',
...
DEFAULT_FR_CA.update({'field.__db_status': 'État de la BD',
 ...
 'legacy.open_in_faq': 'Ouvrir dans la bibliothèque de réponses',
 ...
 'legacy.response_faq': 'Bibliothèque de réponses',
...
DEFAULT_EN_US.update({'legacy.help.a_full_backup_can_contain_provider_api_keys_store_backup_zip_files_securely_installed_ollama_mo': 'A '
 ...
 'legacy.help.could_not_load_response_faq': 'Could not load Response Library.',
 ...
 'legacy.help.saved_to_response_faq_when_caching_succeeds': 'Saved to Response Library when caching succeeds.',
...
DEFAULT_FR_CA.update({'legacy.help.a_full_backup_can_contain_provider_api_keys_store_backup_zip_files_securely_installed_ollama_mo': 'Une '
 ...
 'legacy.help.could_not_load_response_faq': 'Impossible de charger la bibliothèque de réponses.',
 ...
 'legacy.help.saved_to_response_faq_when_caching_succeeds': 'Enregistré dans la bibliothèque de réponses lorsque la mise en '
                                                            'cache réussit.',
...
# 0.36.2 — Bugs in the Machine: shareable view state, work-level insights,
# mixed-metadata inspection, records-table ergonomics, and centralized provider
...
DEFAULT_EN_US.update({
    ...
    "records.shared_workspace_help": "This link preserves the table state and filters, while JSONL contents remain browser-local. Choose the same JSONL file to restore this shared view.",
    "records.open_workspace_help": "Drop one or more JSONL files anywhere on this page, or choose files manually. Each file stays in its own tab and can be edited, compared, searched, exported, or sent to the corpus database.",
    ...
    "works.mixed_values_help": "These are the distinct values currently present across records for this work. Counts help distinguish a dominant value from an isolated inconsistency before you bulk-edit metadata.",
    "works.unknown_source": "Unknown source",
    "works.work_insights": "Work insights",
    "works.indexed_patterns": "Indexed patterns in this work",
    "works.work_insights_help": "Counts are derived from the currently loaded records and use the corpus metadata fields directly.",
...
DEFAULT_FR_CA.update({
    "records.table_scroll_label": "Tableau des fiches. Faites défiler horizontalement pour afficher les colonnes supplémentaires.",
    "records.open_shared_workspace": "Ouvrir l’espace de corpus partagé",
    "records.open_workspace": "Ouvrir un espace de corpus",
    "records.shared_workspace_help": "Ce lien conserve l’état du tableau et les filtres, tandis que le contenu JSONL demeure local au navigateur. Choisissez le même fichier JSONL pour rétablir cette vue partagée.",
    "records.open_workspace_help": "Déposez un ou plusieurs fichiers JSONL n’importe où sur cette page ou choisissez-les manuellement. Chaque fichier demeure dans son propre onglet et peut être modifié, comparé, recherché, exporté ou envoyé à la base de données du corpus.",
    ...
    "works.mixed_values_help": "Voici les valeurs distinctes présentes dans les fiches de cette œuvre. Les nombres permettent de distinguer une valeur dominante d’une incohérence isolée avant une modification en lot.",
    ...
    "works.work_insights_help": "Les nombres sont calculés à partir des fiches actuellement chargées et utilisent directement les champs de métadonnées du corpus.",
    ...
    "llm.connection_from_profile": "Le point de terminaison et les identifiants proviennent du profil de fournisseur et sont gérés de façon centralisée.",
...
# 0.36.10 — In Search of Lost Time: native scholarly Search workspace,
# shareable/saved views, facets, contextual actions, and accessible result layouts.
DEFAULT_EN_US.update({
    'search.title': 'Search',
    'search.kicker': 'Corpus exploration',
    'search.subtitle': 'Explore loaded records or search the corpus database without losing the context of your query, filters, and evidence.',
    ...
    'search.database_result_note': 'Semantic result facets refine the returned candidate set; relevance remains tied to the selected ranking method.',
    'search.sort': 'Sort',
    ...
    'search.ready_help': 'Enter a question, phrase, concept, or passage. Search options control semantic ranking and metadata constraints.',
    ...
    'search.similarity_explanation': 'Similarity is derived from vector distance; higher values indicate a closer semantic match.',
    ...
    'search.save_view_help': 'Saved views preserve the current shareable URL, including scope, query, filters, sort, columns, and layout.',
    ...
    'search.redirect_database': 'Search needs a corpus database. Opening database creation now.',
    'search.contains_filter_removed': 'Contains metadata filters are available only in Filters only mode and were removed.',
})
DEFAULT_FR_CA.update({
    'search.title': 'Recherche',
    'search.kicker': 'Exploration du corpus',
    'search.subtitle': 'Explorez les fiches chargées ou interrogez la base de données du corpus sans perdre le contexte de votre requête, de vos filtres et de vos preuves.',
    ...
    'search.loaded_scope_unavailable': 'La recherche dans les fiches chargées est offerte aux administrateurs qui ont des fiches JSONL locales.',
    ...
    'search.filter_only_help': 'Retourne les fiches à l’aide des filtres de métadonnées sans vectoriser une requête textuelle.',
    ...
    'search.database_result_note': 'Les facettes des résultats sémantiques affinent l’ensemble de candidats retourné; la pertinence demeure liée à la méthode de classement choisie.',
    'search.sort': 'Trier',
    ...
    'search.ready_help': 'Saisissez une question, une expression, un concept ou un passage. Les options de recherche règlent le classement sémantique et les contraintes de métadonnées.',
    'search.no_results': 'Aucune fiche correspondante',
    'search.no_results_help': 'Essayez une requête plus générale, retirez un filtre ou choisissez une autre portée de recherche.',
    'search.similarity_explanation': 'La similarité est dérivée de la distance vectorielle; une valeur plus élevée indique une correspondance sémantique plus étroite.',
    ...
    'search.results_table_scroll': 'Tableau des résultats de recherche. Faites défiler horizontalement pour afficher les colonnes supplémentaires.',
    ...
    'search.save_view_help': 'Les vues enregistrées conservent l’URL partageable actuelle, y compris la portée, la requête, les filtres, le tri, les colonnes et la disposition.',
    ...
    'search.redirect_database': 'La recherche nécessite une base de données du corpus. Ouverture de la création de base de données.',
    'search.contains_filter_removed': 'Les filtres de métadonnées « contient » sont offerts seulement en mode Filtres seulement et ont été retirés.',
})
...
DEFAULT_FR_CA.update({
    ...
    "search.no_database_help": "Une base de données du corpus doit être créée avant de pouvoir lancer une recherche dans la base de données.",
})

# 0.36.11 — Peekaboo: Works import CTA and Response Library naming.
DEFAULT_EN_US.update({
...
# 0.37.0 — New Direction: manifest-backed vector collections and background builds.
DEFAULT_EN_US.update({
    ...
    "vector.source_dataset_help": "Define the logical collection and the corpus material this build will represent. The source selection is recorded in the build manifest.",
    "vector.collection_name_rules": "3–128 characters; start and end with a letter or number; use letters, numbers, periods, underscores, or hyphens.",
    ...
    "vector.language_tags_scope_help": "Descriptive/filtering scope only; mixed-language primary collections are preferred over duplicate physical language databases.",
    "vector.retrieval_contract": "Define the retrieval contract",
    "vector.retrieval_contract_help": "Embedding identity, vector dimension, distance metric, and retrieval mode are treated as a durable collection contract and validated before creation.",
    "vector.embedding_dimension": "Vector dimension",
    "vector.embedding_dimension_help": "DerridAI probes generated embeddings automatically and rejects incompatible dimensions before writing records.",
    ...
    "vector.hybrid_help": "Hybrid fuses semantic and exact lexical retrieval so names, quotations, neologisms, and multilingual terminology can surface independently of embeddings.",
    ...
    "vector.review_build_help": "Creation is strict: DerridAI will never silently reuse an existing collection. The resolved retrieval contract and source snapshot become part of the collection manifest.",
    ...
    "vector.background_build_help": "After the collection is created, {count} selected records will be queued as one server-side background build. You can continue using DerridAI while it runs.",
    "vector.empty_manifest_help": "The empty collection will still retain its validated embedding contract and build manifest.",
    "vector.embedding_model_required": "Choose an Ollama embedding model",
    ...
    "vector.new_direction_build_help": "Choose source material, validate the retrieval contract, then create a manifest-backed collection without blocking the workspace.",
    "vector.creation_steps": "Collection creation steps",
    ...
    "vector.test_retrieval_help": "Compare the collection's semantic, lexical, hybrid, and diversity-aware retrieval behavior against the same stored corpus.",
    ...
    "vector.precomputed_search_help": "Precomputed collections can use lexical search and the lexical leg of hybrid search. Semantic and MMR query embedding require an embedding function.",
    ...
    "vector.manifest_builds_help": "Inspect the reproducible retrieval contract, source snapshot, and recent completed build history for this collection.",
    ...
    "operations.large_sync_background_help": "{count} records will be prepared once, then DerridAI will build and validate the collection as a background operation. You may continue working while the build runs.",
...
DEFAULT_FR_CA.update({
    ...
    "vector.source_dataset_help": "Définissez la collection logique et le corpus que cette construction représentera. La sélection source est inscrite dans le manifeste.",
    "vector.collection_name_rules": "De 3 à 128 caractères; commencez et terminez par une lettre ou un chiffre; utilisez lettres, chiffres, points, traits de soulignement ou traits d’union.",
    "vector.collection_description": "Description",
    "vector.collection_description_placeholder": "Corpus principal multilingue de recherche sur Derrida",
    "vector.language_tags_scope_help": "Portée descriptive et de filtrage seulement; une collection principale multilingue est préférable à des bases physiques dupliquées par langue.",
    "vector.retrieval_contract": "Définir le contrat de recherche",
    "vector.retrieval_contract_help": "L’identité du modèle d’intégration, la dimension, la métrique de distance et le mode de recherche forment un contrat durable validé avant la création.",
    "vector.embedding_dimension": "Dimension vectorielle",
    "vector.embedding_dimension_help": "DerridAI sonde automatiquement les intégrations générées et refuse les dimensions incompatibles avant d’écrire des fiches.",
    ...
    "vector.hybrid_help": "La recherche hybride fusionne les résultats sémantiques et lexicaux exacts afin que noms, citations, néologismes et termes multilingues aient une voie indépendante des intégrations.",
    "vector.deletion_protection": "Protection contre la suppression",
    "vector.deletion_protection_help": "Empêche la suppression accidentelle jusqu’à ce que la protection soit explicitement désactivée.",
    "vector.review_build": "Réviser la construction",
    "vector.review_build_help": "La création est stricte : DerridAI ne réutilise jamais silencieusement une collection existante. Le contrat résolu et l’instantané source font partie du manifeste.",
    ...
    "vector.background_build_help": "Après la création, {count} fiches sélectionnées seront placées dans une seule construction serveur en arrière-plan. Vous pouvez continuer à utiliser DerridAI.",
    "vector.empty_manifest_help": "La collection vide conservera tout de même son contrat d’intégration validé et son manifeste.",
    ...
    "vector.new_direction_build_help": "Choisissez la source, validez le contrat de recherche, puis créez une collection avec manifeste sans bloquer l’espace de travail.",
    "vector.creation_steps": "Étapes de création de la collection",
    ...
    "vector.test_retrieval_help": "Comparez la recherche sémantique, lexicale, hybride et diversifiée sur le même corpus stocké.",
    ...
    "vector.lexical": "Lexical (BM25)",
    "vector.precomputed_search_help": "Les collections à vecteurs précalculés peuvent utiliser la recherche lexicale et le volet lexical de la recherche hybride. Les recherches sémantique et MMR exigent une fonction d’intégration de requête.",
    ...
    "vector.manifest_builds_help": "Consultez le contrat de recherche reproductible, l’instantané source et l’historique récent des constructions achevées.",
    ...
    "operations.vector_sync_active_help": "{label} doit se terminer ou être annulée avant de démarrer une autre construction.",
    "operations.large_sync_background_title": "Construire la collection en arrière-plan?",
    "operations.large_sync_background_help": "{count} fiches seront préparées une fois, puis DerridAI construira et validera la collection en arrière-plan. Vous pouvez continuer à travailler pendant l’opération.",
...
# 0.37.1 — Disoriented: task-focused Vector Stores navigation and inspectors.
DEFAULT_EN_US.update({
    ...
    "vector.compare_modes_help": "Runs the same query across available retrieval modes so you can compare ranking behavior.",
...
DEFAULT_EN_US.update({
    ...
    "pdf_corpus.provider_profile": "Primary LLM provider",
    "pdf_corpus.provider_profile_help": "Use a centrally managed provider profile. Its model and generation defaults remain reusable across DerridAI workflows.",
    "pdf_corpus.escalation_provider": "Escalation provider",
    "pdf_corpus.escalation_provider_help": "Optional fallback used only after the primary provider exhausts structured-output retries.",
    "pdf_corpus.no_escalation_provider": "None — keep failures for human review",
    ...
    "pdf_corpus.retry_in_progress_help": "DerridAI has resumed from the last safe checkpoint. The retry action is locked while this run is active; watch the stage and progress here or on Home.",
    "pdf_corpus.build_stopped_title": "Build stopped before completion",
    "pdf_corpus.build_stopped_help": "Completed checkpoints were preserved. Review the provider and execution settings above, then resume from the last safe checkpoint.",
...
DEFAULT_FR_CA.update({
    ...
    "pdf_workspace.help": "Construisez des jeux de notices vérifiables; la lecture de la source demeure disponible dans l’Explorateur PDF",
    ...
    "pdf_corpus.provider_profile": "Fournisseur LLM principal",
    "pdf_corpus.provider_profile_help": "Utilisez un profil de fournisseur géré centralement. Son modèle et ses paramètres de génération demeurent réutilisables dans les flux DerridAI.",
    "pdf_corpus.escalation_provider": "Fournisseur de relève",
    "pdf_corpus.escalation_provider_help": "Solution de repli facultative utilisée seulement après l’épuisement des tentatives de sortie structurée du fournisseur principal.",
    "pdf_corpus.no_escalation_provider": "Aucun — conserver les échecs pour révision humaine",
    ...
    "pdf_corpus.retry_in_progress_help": "DerridAI a repris au dernier point de contrôle sûr. L’action de nouvelle tentative est verrouillée pendant l’exécution; suivez l’étape et la progression ici ou à l’Accueil.",
    "pdf_corpus.build_stopped_title": "Construction arrêtée avant la fin",
    "pdf_corpus.build_stopped_help": "Les points de contrôle terminés ont été conservés. Vérifiez le fournisseur et les paramètres d’exécution ci-dessus, puis reprenez au dernier point de contrôle sûr.",
    "pdf_corpus.build_stopped_checkpoint": "La reprise ne recommence pas les étapes terminées et ne supprime pas les notices validées.",
    "pdf_corpus.home_title": "Constructions de corpus",
    "pdf_corpus.open_builder": "Ouvrir le générateur de corpus",
    "pdf_corpus.home_help": "Les pipelines PDF-vers-corpus récents restent visibles ici même après avoir quitté le Générateur de corpus.",
...
# 0.43.0 — Crocodile: record-first corpus review and explicit lifecycle.
DEFAULT_EN_US.update({
...
DEFAULT_FR_CA.update({
    "pdf_corpus.review_queue":"File de révision","pdf_corpus.queue_all":"Toutes","pdf_corpus.queue_pending":"En attente","pdf_corpus.queue_attention":"À vérifier","pdf_corpus.queue_metadata":"Métadonnées","pdf_corpus.queue_accepted":"Acceptées","pdf_corpus.queue_rejected":"Rejetées",
...
# 0.43.0 — Crocodile: field-aware metadata and dedicated focus-review workflow.
DEFAULT_EN_US.update({
    ...
    "pdf_corpus.metadata_issue_help":"Only unresolved publication-critical fields are retried. Completed record metadata is preserved.",
    ...
    "pdf_corpus.rejections_blocking_help":"{count} rejected record(s) must be corrected, removed, or reopened before publication.",
    "pdf_corpus.published_completion_help":"The immutable JSONL snapshot is ready to download. Editing this draft will create a new unpublished revision.",
    "pdf_corpus.ready_completion_help":"Record review, source validation, and required metadata gates have passed.",
    "pdf_corpus.metadata_blocking_help":"Record review is complete, but {count} record(s) still have publication-critical metadata to resolve.",
...
DEFAULT_FR_CA.update({
    ...
    "pdf_corpus.metadata_issue_help":"Seuls les champs critiques pour la publication qui ne sont pas résolus sont relancés. Les métadonnées terminées sont conservées.",
    ...
    "pdf_corpus.metadata_retry_start":"Relance des métadonnées pour {count} fiche(s). Les métadonnées terminées ne seront pas recalculées.",
    ...
    "pdf_corpus.rejections_blocking_help":"{count} fiche(s) rejetée(s) doivent être corrigées, supprimées ou rouvertes avant la publication.",
    "pdf_corpus.published_completion_help":"L’instantané JSONL immuable est prêt à être téléchargé. La modification du brouillon créera une nouvelle révision non publiée.",
    "pdf_corpus.ready_completion_help":"La révision, la validation de la source et les contrôles des métadonnées requises sont réussis.",
    "pdf_corpus.metadata_blocking_help":"La révision des fiches est terminée, mais {count} fiche(s) contiennent encore des métadonnées critiques à résoudre.",
...
# 0.43.0 — Crocodile: explicit Finish Corpus, metadata-resolution, and publication-readiness workflow.
DEFAULT_EN_US.update({
    ...
    "pdf_corpus.metadata_retry_failed_help":"The retry stopped without changing successful metadata. Review the remaining issue queue or try again after correcting the provider.",
    "pdf_corpus.automatic_resolution":"Automatic resolution",
    "pdf_corpus.retryable_metadata_fields":"{count} field(s) can be retried",
    "pdf_corpus.retryable_metadata_help":"These issues came from a failed/invalid model response or evidence threshold. Retrying affects only unresolved records; completed metadata and topology are preserved.",
    ...
    "pdf_corpus.human_metadata_help":"These fields are ambiguous or depend on source quality. Review the proposed record, source evidence, allowed values, and field provenance before confirming a value.",
    ...
    "pdf_corpus.metadata_record_help":"Resolve only the required fields shown below. Structural acceptance of this record is tracked separately.",
    ...
    "pdf_corpus.no_retryable_metadata":"No automatically retryable metadata remains. Open the metadata issue queue for human resolution.",
    "pdf_corpus.metadata_retry_start_fields":"Retrying {fields} unresolved field(s) across {records} record(s). Topology and completed metadata are preserved.",
    "pdf_corpus.finish_phase":"Finish corpus",
    "pdf_corpus.finish_corpus_title":"Finish corpus",
    "pdf_corpus.finish_published_help":"This immutable publication snapshot is complete. Editing the draft creates a new unpublished revision.",
    "pdf_corpus.finish_ready_help":"Record review, required metadata, source fidelity, and publication validation have passed.",
    "pdf_corpus.finish_blocked_help":"Record review is complete. Resolve the remaining publication blockers below; DerridAI will then enable publication automatically.",
    ...
    "pdf_corpus.publication_ready_help":"All required gates have passed. Publication creates an immutable UTF-8 JSONL snapshot.",
    "pdf_corpus.publication_waiting_help":"Publication will unlock automatically after the blockers in this Finish corpus view are resolved.",
    ...
    "pdf_corpus.next_action.download_publication":"Download the published snapshot or edit the draft to create a new revision.",
...
DEFAULT_FR_CA.update({
    ...
    "pdf_corpus.metadata_resolution_intro":"La construction du corpus et la révision des fiches peuvent être terminées alors que des métadonnées savantes requises demeurent non résolues. {records} fiche(s) contiennent {fields} problème(s) de champ requis.",
    ...
    "pdf_corpus.metadata_retry_result":"{resolved} champs résolus · {remaining} champs nécessitent encore une vérification",
    "pdf_corpus.metadata_retry_failed_help":"La relance s’est arrêtée sans modifier les métadonnées réussies. Révisez la file restante ou corrigez le fournisseur avant de réessayer.",
    ...
    "pdf_corpus.retryable_metadata_help":"Ces problèmes proviennent d’une réponse de modèle échouée ou invalide, ou d’un seuil de preuve. La relance ne touche que les fiches non résolues; les métadonnées terminées et la topologie sont conservées.",
    ...
    "pdf_corpus.human_metadata_help":"Ces champs sont ambigus ou dépendent de la qualité de la source. Révisez la fiche proposée, les preuves, les valeurs permises et la provenance avant de confirmer une valeur.",
    ...
    "pdf_corpus.metadata_record_help":"Ne résolvez que les champs requis affichés ci-dessous. L’acceptation structurelle de cette fiche est suivie séparément.",
    ...
    "pdf_corpus.no_retryable_metadata":"Aucune métadonnée relançable automatiquement ne reste. Ouvrez la file des problèmes pour une résolution humaine.",
    "pdf_corpus.metadata_retry_start_fields":"Relance de {fields} champ(s) non résolu(s) dans {records} fiche(s). La topologie et les métadonnées terminées sont conservées.",
    "pdf_corpus.finish_phase":"Terminer le corpus",
    "pdf_corpus.finish_corpus_title":"Terminer le corpus",
    "pdf_corpus.finish_published_help":"Cet instantané de publication immuable est terminé. La modification du brouillon crée une nouvelle révision non publiée.",
    "pdf_corpus.finish_ready_help":"La révision des fiches, les métadonnées requises, la fidélité à la source et la validation de publication sont réussies.",
    "pdf_corpus.finish_blocked_help":"La révision des fiches est terminée. Résolvez les obstacles restants ci-dessous; DerridAI activera ensuite automatiquement la publication.",
    ...
    "pdf_corpus.finish_metadata_complete":"Tous les champs de métadonnées requis pour la publication sont résolus et validés.",
    ...
    "pdf_corpus.publication_ready_help":"Tous les contrôles requis sont réussis. La publication crée un instantané JSONL UTF-8 immuable.",
    "pdf_corpus.publication_waiting_help":"La publication sera activée automatiquement après la résolution des obstacles de cette vue Terminer le corpus.",
    ...
    "pdf_corpus.next_action.download_publication":"Téléchargez l’instantané publié ou modifiez le brouillon pour créer une nouvelle révision.",
...
DEFAULT_EN_US.update({
    ...
    "pdf_corpus.review_mode_help":"Review the proposed record and its metadata together. Build diagnostics remain available under Technical build details.",
    ...
    "pdf_corpus.primary_text_help":"Choose whether this record belongs to the substantive work rather than front/back matter or publishing apparatus.",
    ...
    "pdf_corpus.bulk_done_metadata_blocked":"Accepted {count} eligible record(s); {blocked} record(s) still require metadata decisions and are now shown in the metadata queue.",
})
DEFAULT_FR_CA.update({
    "pdf_corpus.review_mode":"Révision des fiches",
    "pdf_corpus.review_progress_compact":"{accepted} acceptées · {pending} en attente · {metadata} décisions de métadonnées",
    "pdf_corpus.review_mode_help":"Révisez la fiche proposée et ses métadonnées ensemble. Les diagnostics de construction restent accessibles sous Détails techniques de la construction.",
    ...
    "pdf_corpus.evidence_review_help":"Sélectionnez un champ de métadonnées pour inspecter ou ajuster ses preuves liées aux blocs sources.",
    ...
    "pdf_corpus.primary_text_help":"Indiquez si cette fiche appartient au texte substantiel de l’œuvre plutôt qu’aux pages liminaires/finales ou à l’appareil éditorial.",
...
# 0.44.0 — Dachshund: exception-oriented corpus review and durable metadata decisions.
DEFAULT_EN_US.update({
    "pdf_corpus.queue_ready":"Ready",
    "pdf_corpus.queue_issues":"Needs attention",
    "pdf_corpus.queue_topology":"Topology",
    "pdf_corpus.accept_clean":"Accept clean ({count})",
    "pdf_corpus.accept_clean_confirm":"Accept {count} clean record(s)? Records with metadata, topology, or source problems will remain for review.",
    ...
    "pdf_corpus.reject_queue":"Reject this queue",
    ...
    "pdf_corpus.metadata_inline_help":"Metadata is reviewed with the record. Only uncertain fields require an explicit decision.",
...
DEFAULT_FR_CA.update({
    ...
    "pdf_corpus.accept_clean_confirm":"Accepter {count} fiche(s) sans problème? Les fiches ayant des problèmes de métadonnées, de topologie ou de source resteront à réviser.",
    ...
    "pdf_corpus.reject_queue":"Rejeter cette file",
    ...
    "pdf_corpus.metadata_inline_help":"Les métadonnées sont révisées avec la fiche. Seuls les champs incertains exigent une décision explicite.",
