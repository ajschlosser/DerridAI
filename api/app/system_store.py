            ...
            for code, value in self._default()["languages"].items():
                if code not in languages:
                    ...
                    if "flag" not in languages[code]:
                        ...
                        changed = True
                    if code == "en-US" and (languages[code].get("name") != "U.S. English" or languages[code].get("flag") != "🇺🇸"):
                        languages[code]["name"] = "U.S. English"
                        languages[code]["flag"] = "🇺🇸"
                        changed = True
                    if code == "fr-CA" and (languages[code].get("name") != "Français (Québec)" or languages[code].get("flag") != "🇨🇦"):
                        languages[code]["name"] = "Français (Québec)"
                        languages[code]["flag"] = "🇨🇦"
                        changed = True
...
DEFAULT_EN_US.update({
    ...
    "faq.search_label": "Search cached questions",
    "faq.search_placeholder": "Search cached questions",
    "faq.cached_responses": "cached responses",
    "faq.matches": "matches",
    "faq.loading": "Loading cached research responses…",
    "faq.no_matches": "No cached responses match this search",
    "faq.no_matches_help": "Try a broader question or clear the search.",
...
DEFAULT_FR_CA.update({
    ...
    "faq.search_label": "Rechercher dans les questions mises en cache",
    "faq.search_placeholder": "Rechercher dans les questions mises en cache",
    ...
    "faq.no_matches": "Aucune réponse mise en cache ne correspond à cette recherche",
    "faq.no_matches_help": "Élargissez la recherche ou effacez-la pour voir davantage de résultats.",
...
DEFAULT_EN_US.update({
    ...
    "faq.library_title": "Saved research",
    "faq.library_help": "Browse prior answers without losing their evidence bindings.",
    "faq.saved_on": "Saved",
...
DEFAULT_FR_CA.update({
    ...
    "faq.library_title": "Recherches enregistrées",
    "faq.library_help": "Parcourez les réponses antérieures sans perdre leurs liaisons aux preuves.",
...
DEFAULT_EN_US.update({
    ...
    "faq.archive_help": "Search and reopen prior Research answers without compressing the answer workspace.",
...
DEFAULT_FR_CA.update({
    ...
    "faq.archive_help": "Recherchez et rouvrez des réponses de Recherche antérieures sans réduire l’espace consacré à la réponse.",
