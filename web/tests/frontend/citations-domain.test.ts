...
import { fullCitation, inlineCitation, mlaAuthorName, mlaPageSpan } from "../../src/domain/citations";
...
describe("citations", () => {
  ...
  it("builds inline citations", () => {
    expect(inlineCitation({ document_author: "Jacques Derrida", year: 1997, page_start: 5, page_end: 8 })).toBe("(Derrida 1997: 5-8)");
  ...
  it("builds full citations", () => {
    expect(
      fullCitation({ document_author: "Jacques Derrida", work: "Of Grammatology", translator: "G. Spivak", publisher: "JHU Press", year: 1976, page_start: 5 }),
