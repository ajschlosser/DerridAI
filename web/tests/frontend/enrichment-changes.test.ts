...
const record = (over: Record<string, unknown> = {}) => ({
  ...
  metadata_field_status: {
    ...
    target: { status: "unresolved", method: "llm", verification_status: "pending_review" },
  },
...
const mountWith = (r: Record<string, unknown>) =>
  mount(CorpusEnrichmentChanges, { props: { record: r } });
...
describe("changes made by enrichment", () => {
  ...
  it("shows authoritative candidates with provenance outside the action", () => {
    ...
    expect(text).toContain("cities of refuge");
        ...
        metadata_disputes: [
          {
            ...
            candidates: [
              { value: "cities of refuge", source: "current" },
              { value: "hospitality", source: "llm", model: "m1", pass: 1 },
              { value: "cosmopolitanism", source: "llm", model: "m2", pass: 2 },
            ],
          },
        ],
      }),
    );
    expect(wrapper.text()).toContain("cosmopolitanism");
            ...
            informational: [
              {
                ...
                pass: 3,
                confidence: 0.92,
                reason: "Human-owned value retained.",
              },
              {
                kind: "agreement",
                field: "stance",
                authoritative_value: "critical",
                proposed_value: "critical",
                model: "qwen3.5:4b",
                pass: 3,
                reason: "No new supported value.",
              },
            ],
          },
        ],
