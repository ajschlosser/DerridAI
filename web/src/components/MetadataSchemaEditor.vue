            ...
            <div class="row">
              ...
              <label class="schema-field"
                ><span
                  ...
                  <UiTooltip :text="t('review_visibility_help', schemaHelp.reviewVisibility)" /></span
            ...
            <div class="row nlp-hints">
              <label class="schema-field"
                ...
                <small class="hint">{{
                  t(
                    "pos_tags_help",
                    "Autocomplete uses the Universal POS tag set. These are advisory enrichment hints, not additional output fields.",
                  )
                }}</small>
              </label>
              <label class="schema-field"
                ...
                <small class="hint">{{
                  t(
                    "ner_tags_help",
                    "Autocomplete uses DerridAI's supported NER vocabulary. These are advisory enrichment hints and do not change the field type.",
                  )
                }}</small>
              </label>
            </div>
