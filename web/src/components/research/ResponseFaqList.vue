...
<style scoped>
.response-library-list{display:grid;gap:5px;padding:1px}.response-library-list>button{width:100%;min-width:0;display:grid;grid-template-columns:32px minmax(0,1fr) 18px;gap:10px;align-items:start;border:1px solid #e7ebef;border-radius:11px;background:#fff;padding:12px 11px;color:#2e4057;text-align:left;cursor:pointer;box-shadow:0 1px 2px rgba(15,23,42,.02)}.response-library-list>button:hover{border-color:#cfd9df;background:#fbfcfd}.response-library-list>button.active{border-color:#b8d2c2;background:var(--ui-accent-soft,#edf7f0);box-shadow:inset 3px 0 0 var(--ui-accent,#3c8d62)}.response-library-question-icon{width:30px;height:30px;display:grid;place-items:center;margin-top:1px;border-radius:9px;background:#f0f4f6;color:#526779;font-size:.8125rem;font-weight:850}.response-library-list>button.active .response-library-question-icon{background:#fff;color:var(--ui-accent-dark)}.response-library-list-main{min-width:0;display:grid;gap:7px}.response-library-list-question{color:#23354b;font-size:15px;font-weight:790;line-height:1.38;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;overflow:hidden}.response-library-list-question mark{border-radius:3px;background:#fff0a8;color:inherit;padding:0 1px}.response-library-list-meta{display:flex;align-items:center;gap:5px 9px;flex-wrap:wrap;color:#8490a0;font-size:.8125rem}.response-library-list-meta>span{display:inline-flex;align-items:center;gap:4px;min-width:0;max-width:100%}.response-library-list-meta .model{max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.response-library-list-meta svg{width:11px;height:11px}.response-library-list-meta .grade{color:#3f6650;font-weight:800}.response-library-open{align-self:center;color:#9aa7b5;font-size:22px;line-height:1}.response-library-list>button:hover .response-library-open,.response-library-list>button.active .response-library-open{color:var(--ui-accent-dark)}.response-library-list>button:focus-visible{outline:3px solid var(--ui-accent-focus);outline-offset:1px}@media(max-width:520px){.response-library-list>button{grid-template-columns:26px minmax(0,1fr) 14px;padding:10px 9px;gap:8px}.response-library-question-icon{width:25px;height:25px;border-radius:7px}.response-library-list-question{font-size:14px}.response-library-list-meta .model{max-width:150px}}
</style>
