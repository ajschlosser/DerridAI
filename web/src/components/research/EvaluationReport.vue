...
<style scoped>
.evaluation-report{display:grid;gap:14px;padding:14px;border:1px solid var(--line);border-radius:13px;background:linear-gradient(180deg,var(--card),var(--card));color:var(--text-2)}.evaluation-report-hero{display:grid;grid-template-columns:72px minmax(0,1fr);gap:14px;align-items:start}.evaluation-score{width:72px;height:72px;display:flex;align-items:baseline;justify-content:center;padding-top:15px;border:1px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 28%,var(--line));border-radius:16px;background:var(--ui-accent-soft,#edf7f0);color: var(--accent-fg)}.evaluation-score strong{font-size:1.6875rem;line-height:1;font-variant-numeric:tabular-nums}.evaluation-score span{font-size:.8125rem;font-weight:800}.evaluation-kicker{display:block;margin-bottom:3px;color:var(--muted);font-size:.8125rem;font-weight:800;letter-spacing:.07em;text-transform:uppercase}.evaluation-report-hero h3{margin:0;color:var(--text-2);font-size:0.9375rem;line-height:1.4}.evaluation-report-hero p{margin:5px 0 0;color:var(--muted);font-size:.8125rem;line-height:1.55}.evaluation-categories{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.evaluation-category{display:grid;gap:7px;padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--card)}.evaluation-category-head{display:flex;align-items:baseline;justify-content:space-between;gap:10px}.evaluation-category-head strong{color:var(--text-2);font-size:.8125rem}.evaluation-category-head span{color: var(--accent-fg);font-size:0.875rem;font-weight:850;font-variant-numeric:tabular-nums}.evaluation-category-head small{color:var(--muted);font-size:.8125rem}.evaluation-meter{height:5px;overflow:hidden;border-radius:999px;background:var(--soft)}.evaluation-meter i{display:block;height:100%;border-radius:inherit;background:var(--ui-accent,#3c8d62)}.evaluation-category p{margin:0;color:var(--muted);font-size:.8125rem;line-height:1.45}.evaluation-findings{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.evaluation-finding{min-width:0;padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--card)}.evaluation-finding header{display:flex;align-items:center;gap:6px;color:var(--text-2)}.evaluation-finding header :deep(svg){width:14px;height:14px}.evaluation-finding h4{margin:0;font-size:.8125rem}.evaluation-finding ul{margin:7px 0 0;padding-inline-start:18px;color:var(--muted);font-size:.8125rem;line-height:1.45}.evaluation-finding.positive{border-color:var(--line)}.evaluation-finding.positive header{color: var(--accent-fg)}.evaluation-finding.risk{border-color:var(--tone-warn-edge);background:var(--tone-warn-bg)}.evaluation-finding.risk header{color:var(--tone-warn-fg)}.evaluation-raw{border-top:1px solid var(--line);padding-top:7px}.evaluation-raw>summary{width:max-content;max-width:100%;min-height:32px;display:flex;align-items:center;color:var(--muted);font-size:.8125rem;font-weight:800;cursor:pointer}.evaluation-raw>p{margin:0 0 7px;color:var(--muted);font-size:.8125rem}.evaluation-raw pre{max-height:320px;margin:0;overflow:auto;padding:10px;border:1px solid var(--line);border-radius:8px;background:var(--card);white-space:pre-wrap;overflow-wrap:anywhere;color:var(--text-2);font:12px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace}.evaluation-report :is(summary):focus-visible{outline:3px solid var(--ui-accent-focus);outline-offset:2px}@media(max-width:840px){.evaluation-findings{grid-template-columns:1fr}.evaluation-categories{grid-template-columns:1fr}}@media(max-width:520px){.evaluation-report-hero{grid-template-columns:1fr}.evaluation-score{width:64px;height:64px;padding-top:12px}}
</style>
