...
<style scoped>
.evaluation-report{display:grid;gap:14px;padding:14px;border:1px solid #dfe7e2;border-radius:13px;background:linear-gradient(180deg,#fff,#fbfcfb);color:#32465a}.evaluation-report-hero{display:grid;grid-template-columns:72px minmax(0,1fr);gap:14px;align-items:start}.evaluation-score{width:72px;height:72px;display:flex;align-items:baseline;justify-content:center;padding-top:15px;border:1px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 28%,#dfe6e2);border-radius:16px;background:var(--ui-accent-soft,#edf7f0);color:var(--ui-accent-dark,#286543)}.evaluation-score strong{font-size:27px;line-height:1;font-variant-numeric:tabular-nums}.evaluation-score span{font-size:.8125rem;font-weight:800}.evaluation-kicker{display:block;margin-bottom:3px;color:#718096;font-size:.8125rem;font-weight:800;letter-spacing:.07em;text-transform:uppercase}.evaluation-report-hero h3{margin:0;color:#293d52;font-size:15px;line-height:1.4}.evaluation-report-hero p{margin:5px 0 0;color:#5f7084;font-size:.8125rem;line-height:1.55}.evaluation-categories{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.evaluation-category{display:grid;gap:7px;padding:10px;border:1px solid #e2e8e5;border-radius:10px;background:#fff}.evaluation-category-head{display:flex;align-items:baseline;justify-content:space-between;gap:10px}.evaluation-category-head strong{color:#405267;font-size:.8125rem}.evaluation-category-head span{color:var(--ui-accent-dark,#286543);font-size:14px;font-weight:850;font-variant-numeric:tabular-nums}.evaluation-category-head small{color:#7a8797;font-size:.8125rem}.evaluation-meter{height:5px;overflow:hidden;border-radius:999px;background:#e9eeeb}.evaluation-meter i{display:block;height:100%;border-radius:inherit;background:var(--ui-accent,#3c8d62)}.evaluation-category p{margin:0;color:#68788b;font-size:.8125rem;line-height:1.45}.evaluation-findings{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.evaluation-finding{min-width:0;padding:10px;border:1px solid #e2e7eb;border-radius:10px;background:#fff}.evaluation-finding header{display:flex;align-items:center;gap:6px;color:#5b687a}.evaluation-finding header :deep(svg){width:14px;height:14px}.evaluation-finding h4{margin:0;font-size:.8125rem}.evaluation-finding ul{margin:7px 0 0;padding-inline-start:18px;color:#5e6f82;font-size:.8125rem;line-height:1.45}.evaluation-finding.positive{border-color:#d9e8df}.evaluation-finding.positive header{color:var(--ui-accent-dark,#286543)}.evaluation-finding.risk{border-color:#eadfce;background:#fffcf7}.evaluation-finding.risk header{color:#835f2d}.evaluation-raw{border-top:1px solid #e6ebe8;padding-top:7px}.evaluation-raw>summary{width:max-content;max-width:100%;min-height:32px;display:flex;align-items:center;color:#607186;font-size:.8125rem;font-weight:800;cursor:pointer}.evaluation-raw>p{margin:0 0 7px;color:#7a8796;font-size:.8125rem}.evaluation-raw pre{max-height:320px;margin:0;overflow:auto;padding:10px;border:1px solid #e2e8e5;border-radius:8px;background:#f7f9f8;white-space:pre-wrap;overflow-wrap:anywhere;color:#46586b;font:12px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace}.evaluation-report :is(summary):focus-visible{outline:3px solid var(--ui-accent-focus);outline-offset:2px}@media(max-width:840px){.evaluation-findings{grid-template-columns:1fr}.evaluation-categories{grid-template-columns:1fr}}@media(max-width:520px){.evaluation-report-hero{grid-template-columns:1fr}.evaluation-score{width:64px;height:64px;padding-top:12px}}
</style>
