...
const build: any = {
  ...
  pipeline_state: {
    ...
    review: { state: "active" },
    validation: { state: "waiting" },
    publication: { state: "waiting" },
  },
  publication_readiness: { next_action: "continue_review" },
};
const meta = {
  title: "Corpus Builder/Workflow/Build Lifecycle",
  component: CorpusBuildLifecycleCard,
  args: { build },
} satisfies Meta<typeof CorpusBuildLifecycleCard>;
export default meta;
