...
const meta={title:'Corpus Builder/Enrichment/Provider Switcher',component:CorpusProviderSwitcher,args:{profiles,activeProfileId:'gemma26',activeModel:profiles[0].model,history:[{at:'2026-09-18T12:00:00Z',provider_profile_id:'qwen27',model:'Qwen3.8-27B',metadata_completed:0},{at:'2026-09-18T12:20:00Z',provider_profile_id:'gemma26',model:profiles[0].model,metadata_completed:12}]}} satisfies Meta<typeof CorpusProviderSwitcher>;
export default meta;
