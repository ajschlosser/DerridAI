...
const meta = { title:"LLM/Provider Profile Select", component:ProviderProfileSelect, args:{ modelValue:"ollama-local", profiles, defaultProfileId:"ollama-local" } } satisfies Meta<typeof ProviderProfileSelect>;
