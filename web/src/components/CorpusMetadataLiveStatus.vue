...
.metadata-live-status[data-stalled="true"]{border-color:#c89f36;background:#fff9ea}.status-main{display:grid;gap:7px;min-width:0}.status-title-row{display:flex;justify-content:space-between;gap:16px;align-items:flex-start}.eyebrow{font-size:.8125rem;line-height:1.35;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);font-weight:800}.status-title-row h2{margin:2px 0 0;font-size:17px;line-height:1.3}.status-count{font-size:18px;white-space:nowrap}.status-main p{margin:0;font-size:13px;line-height:1.45}.status-secondary{color:var(--muted)}.saved-indicator{width:max-content;max-width:100%;padding:3px 7px;border-radius:999px;background:#edf8f1;color:#315843!important;font-size:.8125rem!important;font-weight:750}.progress-track{height:8px;overflow:hidden;border-radius:999px;background:var(--soft)}.progress-track span{display:block;height:100%;background:var(--accent);transition:width .2s ease}.active-tasks{display:grid;gap:7px;min-width:0}.active-tasks>b{font-size:13px}.active-tasks ul{list-style:none;margin:0;padding:0;display:grid;gap:4px}.active-tasks li{display:flex;justify-content:space-between;gap:10px;font-size:.8125rem;line-height:1.4}.active-tasks li span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted)}.active-tasks li strong{white-space:nowrap}.active-tasks li small{font-size:.8125rem;color:var(--muted);font-weight:600}.status-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.btn{min-height:40px;font-size:13px}.btn:focus-visible{outline:3px solid var(--accent);outline-offset:2px}@media(max-width:1050px){.metadata-live-status{grid-template-columns:1fr 1fr}.status-actions{grid-column:1/-1;justify-content:flex-start}}@media(max-width:700px){.metadata-live-status{grid-template-columns:1fr}.status-actions{grid-column:auto}}@media(prefers-reduced-motion:reduce){.progress-track span{transition:none}}
</style>
