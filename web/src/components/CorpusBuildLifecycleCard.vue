...
<style scoped>
.lifecycle-card{display:grid;gap:11px;padding:13px 14px;border:1px solid var(--line);border-radius:11px;background:var(--soft)}header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}header h3{font-size:13px;margin:2px 0 0}header>strong{font-size:18px}.eyebrow{font-size:9px;color:var(--muted);text-transform:uppercase;letter-spacing:.07em}.pipeline{list-style:none;display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px;margin:0;padding:0}.pipeline li{display:grid;grid-template-columns:10px minmax(0,1fr);gap:7px;padding:8px;border:1px solid var(--line);border-radius:8px;background:var(--card)}.pipeline .marker{width:8px;height:8px;margin-top:2px;border-radius:50%;background:#969696}.pipeline li[data-state="complete"] .marker{background:#287a4c}.pipeline li[data-state="active"] .marker{background:var(--accent)}.pipeline li[data-state="attention"] .marker{background:#a57914}.pipeline li[data-state="blocked"] .marker{background:#a13f3f}.pipeline li div{display:grid;gap:2px;min-width:0}.pipeline b{font-size:9px}.pipeline small{font-size:8px;line-height:1.35;color:var(--muted)}.next-action{display:flex;gap:8px;align-items:baseline;padding-top:2px;font-size:10px}.next-action b{white-space:nowrap}.next-action span{color:var(--muted)}@media(max-width:1200px){.pipeline{grid-template-columns:repeat(3,1fr)}}@media(max-width:700px){.pipeline{grid-template-columns:1fr}.next-action{display:grid}}
</style>
