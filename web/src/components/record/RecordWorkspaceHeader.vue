...
<style scoped>
.record-workspace-header{position:sticky;top:0;z-index:20;display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:18px;align-items:center;padding:14px 18px;border:1px solid var(--line,#dfe6ed);border-radius:16px;background:color-mix(in srgb,var(--card) 94%,var(--ui-accent-soft,#eef7f1));box-shadow:0 8px 28px rgba(15,23,42,.07);backdrop-filter:blur(14px)}
.record-workspace-nav{display:flex;align-items:center;gap:6px}.record-icon-button{width:38px;height:38px;border:1px solid var(--line,#dfe6ed);border-radius:10px;background:var(--card);color:var(--text-2);font-size:1.0625rem;cursor:pointer}.record-icon-button:disabled{opacity:.4;cursor:not-allowed}.record-position{min-width:62px;text-align:center;font-size:.8125rem;color:var(--muted);font-variant-numeric:tabular-nums}.record-identity{min-width:0}.record-kicker{margin:0 0 4px;color:var(--accent-fg);font-size:var(--page-kicker-size);font-weight:var(--fw-bold);letter-spacing:.08em;line-height:var(--lh-tight);text-transform:uppercase}.record-identity h1{margin:0;max-width:100%;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;overflow-wrap:anywhere}.record-identity h1.record-title-medium{--page-title-size:clamp(1.25rem,1.75vw,1.6875rem)}.record-identity h1.record-title-long{--page-title-size:clamp(1.125rem,1.55vw,1.4375rem)}.record-identity h1.record-title-xlong{--page-title-size:clamp(1.0625rem,1.35vw,1.3125rem)}.record-identity-meta{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-top:5px;color:var(--muted);font-size:0.78125rem}.record-identity-meta>span+span:before{content:"·";margin-right:8px;color:#a0aab6}.record-id{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;color:var(--muted)}.record-header-actions{display:flex;align-items:center;gap:8px}.record-primary-action{min-height:38px;display:inline-flex;align-items:center;gap:7px;border:1px solid var(--line);border-radius:10px;background:var(--card);padding:0 12px;color:var(--text);font-weight:700;cursor:pointer}.record-primary-action.selected{background:var(--ui-accent-soft,#edf7f0);border-color:color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--line))}.record-primary-action :deep(svg){width:16px;height:16px}.record-more-menu{position:relative}.record-more-menu summary{list-style:none;width:38px;height:38px;display:grid;place-items:center;border:1px solid var(--line,#dfe6ed);border-radius:10px;background:var(--card);cursor:pointer;font-weight:900;letter-spacing:2px}.record-more-menu summary::-webkit-details-marker{display:none}.record-more-popover{position:absolute;right:0;top:46px;z-index:40;width:250px;padding:7px;border:1px solid var(--line,#dfe6ed);border-radius:12px;background:var(--card);box-shadow:0 18px 50px rgba(15,23,42,.16)}.record-more-popover button{width:100%;min-height:38px;display:flex;align-items:center;gap:9px;border:0;border-radius:8px;background:transparent;padding:8px 10px;text-align:left;color:var(--text-2);cursor:pointer}.record-more-popover button:hover,.record-more-popover button:focus-visible{background:var(--soft)}.record-more-popover :deep(svg){width:16px;height:16px}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
.record-shortcuts{position:relative}.record-shortcuts summary{list-style:none;width:38px;height:38px;display:grid;place-items:center;border:1px solid var(--line,#dfe6ed);border-radius:10px;background:var(--card);cursor:pointer;font-weight:900}.record-shortcuts summary::-webkit-details-marker{display:none}.record-shortcuts-popover{position:absolute;right:0;top:46px;z-index:40;width:250px;display:grid;gap:8px;padding:10px;border:1px solid var(--line,#dfe6ed);border-radius:12px;background:var(--card);box-shadow:0 18px 50px rgba(15,23,42,.16);font-size:.75rem}.record-shortcuts-popover span{color:var(--muted)}kbd{border:1px solid var(--line);border-radius:4px;background:var(--soft);padding:1px 4px;font-family:inherit;font-size:.75rem}
button:focus-visible,summary:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 45%,var(--card));outline-offset:2px}
