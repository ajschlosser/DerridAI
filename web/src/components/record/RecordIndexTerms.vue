...
<style scoped>
.record-index-terms{display:grid;gap:11px}.record-index-terms header{display:flex;justify-content:space-between;align-items:center}.record-index-terms h3{margin:0;font-size:0.8125rem}.record-index-terms header>span{min-width:26px;height:26px;display:grid;place-items:center;border-radius:999px;background:var(--soft);color:var(--text-2);font-size:.8125rem;font-weight:800}.record-index-chip-list{display:flex;flex-wrap:wrap;gap:7px;align-items:flex-start}.record-index-chip{display:inline-flex;width:auto;max-width:100%;align-items:stretch;border:1px solid var(--line);border-radius:999px;background:var(--soft);overflow:hidden}.record-index-search{display:inline-flex;width:auto;max-width:100%;min-height:32px;align-items:center;border:0;background:transparent;padding:5px 10px;color:var(--text-2);font-size:0.78125rem;font-weight:700;white-space:normal;overflow-wrap:anywhere;text-align:left;cursor:pointer}.record-index-remove{width:31px;min-width:31px;min-height:31px;border:0;border-left:1px solid var(--line);background:transparent;color:var(--muted);cursor:pointer}.record-index-search:hover,.record-index-search:focus-visible,.record-index-remove:hover,.record-index-remove:focus-visible{background:var(--tone-ok-bg)}.record-index-empty{color:var(--muted);font-size:0.78125rem}.record-index-add{display:flex;gap:7px}.record-index-add label{flex:1}.record-index-add input{width:100%;min-height:36px;border:1px solid var(--line);border-radius:9px;padding:0 10px;font-size:0.8125rem}.record-index-add>button{min-height:36px;border:1px solid var(--line);border-radius:9px;background:var(--card);padding:0 11px;color:var(--text-2);font-weight:800;cursor:pointer}.record-index-add>button:disabled{opacity:.45;cursor:not-allowed}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}button:focus-visible,input:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--card));outline-offset:2px}
</style>
