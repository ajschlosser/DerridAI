...
<style scoped>
.provenance-map{display:grid;gap:14px;min-width:0}.provenance-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.provenance-head p{margin:0;color:#64748b;font-size:.8125rem;font-weight:800;text-transform:uppercase;letter-spacing:.065em}.provenance-head h2{margin:2px 0 0;color:#27394f;font-size:17px;line-height:1.2}.provenance-count{min-width:28px;height:28px;display:grid;place-items:center;border:1px solid #dbe5df;border-radius:999px;background:#f7faf8;color:#42604f;font-size:.8125rem;font-weight:800}.provenance-help{margin:-3px 0 0;color:#69788b;font-size:.8125rem;line-height:1.5}.provenance-path{display:grid;gap:0;margin:0;padding:0;list-style:none}.provenance-path li{position:relative;display:grid;grid-template-columns:30px minmax(0,1fr);gap:10px;align-items:start;min-width:0}.provenance-path li:not(:last-child){padding-bottom:9px}.provenance-path li:not(:last-child)::after{content:"";position:absolute;left:14px;top:29px;bottom:-1px;width:1px;background:#dce6e0}.provenance-step{position:relative;z-index:1;width:29px;height:29px;display:grid;place-items:center;border:1px solid #cfdcd4;border-radius:999px;background:#fff;color:#557064;font-size:.8125rem;font-weight:850}.provenance-path button{min-width:0;width:100%;display:grid;gap:3px;border:1px solid #e1e8e4;border-radius:10px;background:#fafcfb;padding:9px 10px;color:#2c4437;text-align:left;cursor:pointer}.provenance-path button:hover{border-color:#cbdad1;background:#fff}.provenance-path small{color:#718096;font-size:.8125rem;font-weight:800;text-transform:uppercase;letter-spacing:.045em}.provenance-path strong{min-width:0;font-size:13px;line-height:1.4;overflow-wrap:anywhere}.provenance-support{display:grid;gap:0;margin:2px 0 0;border-top:1px solid #e5ebe7}.provenance-support>div{display:grid;grid-template-columns:minmax(108px,.72fr) minmax(0,1fr);gap:10px;padding:9px 0;border-bottom:1px solid #edf1ef}.provenance-support dt{color:#6c7a8d;font-size:.8125rem}.provenance-support dd{min-width:0;margin:0}.provenance-support button{max-width:100%;border:0;background:transparent;padding:0;color:#2f5944;font-size:.8125rem;font-weight:750;text-align:left;overflow-wrap:anywhere;cursor:pointer;text-decoration:underline;text-decoration-color:#c4d8cc;text-underline-offset:2px}.provenance-empty{margin:0;padding:12px;border:1px dashed #d9e2dd;border-radius:10px;background:#fafcfb;color:#6b7788;font-size:12.5px;line-height:1.55}button:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,#fff);outline-offset:2px}@media(max-width:480px){.provenance-support>div{grid-template-columns:1fr;gap:3px}}
</style>
