...
<style scoped>
.record-inspector{position:sticky;top:92px;max-height:calc(100dvh - 112px);min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);border:1px solid var(--line);border-radius:16px;background:var(--card);box-shadow:0 8px 24px rgba(15,23,42,.045);overflow:hidden}.record-inspector-tabs{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px;padding:7px;border-bottom:1px solid var(--line);background:var(--card)}.record-inspector-tabs button{position:relative;min-width:0;min-height:38px;display:flex;align-items:center;justify-content:center;gap:5px;border:1px solid transparent;border-radius:8px;background:transparent;padding:5px 7px;color:var(--muted);font-size:.8125rem;font-weight:780;line-height:1.15;text-align:center;white-space:normal;cursor:pointer}.record-inspector-tabs button:hover{background:var(--card);border-color:var(--line)}.record-inspector-tabs button.active{border-color:var(--line);background:var(--card);color:var(--text-2);box-shadow:0 1px 4px rgba(15,23,42,.05)}.record-inspector-tabs button>span{min-width:18px;height:18px;display:grid;place-items:center;border-radius:999px;background:var(--soft);font-size:.8125rem}.record-inspector-body{min-height:0;overflow-x:hidden;overflow-y:auto;overscroll-behavior:auto;padding:15px 16px 18px;scrollbar-gutter:stable}.record-overview-panel,.record-indexing-panel{display:grid;gap:17px}.record-page-value{font-variant-numeric:tabular-nums}.inspector-section-head p{margin:0;color:var(--muted);font-size:.8125rem;font-weight:800;text-transform:uppercase;letter-spacing:.06em}.inspector-section-head h2{margin:2px 0 0;color:var(--text-2);font-size:1.0625rem}.record-meta-list{display:grid;margin:0}.record-meta-list>div{display:grid;grid-template-columns:minmax(100px,.68fr) minmax(0,1fr);gap:10px;padding:9px 0;border-bottom:1px solid var(--line)}.record-meta-list dt{color:var(--muted);font-size:.8125rem}.record-meta-list dd{margin:0;min-width:0;color:var(--text-2);font-size:0.78125rem;font-weight:700;overflow-wrap:anywhere}.record-meta-list dd button{max-width:100%;border:0;background:transparent;padding:0;color:var(--tone-ok-fg);font:inherit;text-align:left;cursor:pointer;text-decoration:underline;text-decoration-color:#bdd3c6;text-underline-offset:2px;overflow-wrap:anywhere}.quoted-meta,.citation-preview{display:grid;gap:9px;padding-top:2px}.quoted-meta h3,.citation-preview h3{margin:0;color:var(--text-2);font-size:0.8125rem}.citation-preview>div{padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--card)}.citation-preview small{color:var(--muted);font-size:.8125rem;font-weight:800;text-transform:uppercase}.citation-preview p{margin:4px 0 0;color:var(--text-2);font:12.5px/1.5 Georgia,"Times New Roman",serif;overflow-wrap:anywhere}.record-indexing-panel :deep(.record-index-terms+.record-index-terms){padding-top:15px;border-top:1px solid var(--line)}button:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--card));outline-offset:2px}
