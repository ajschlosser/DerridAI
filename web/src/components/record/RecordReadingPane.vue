...
<style scoped>
.record-reading-pane{min-width:0;border:1px solid var(--line);border-radius:16px;background:var(--card);box-shadow:0 8px 24px rgba(15,23,42,.045);overflow:hidden}.record-reading-toolbar{display:flex;justify-content:space-between;gap:18px;align-items:center;padding:14px 18px;border-bottom:1px solid var(--line);background:var(--card)}.record-reading-toolbar p{margin:0;color:var(--text);font-size:0.84375rem;font-weight:800}.record-reading-toolbar span{display:block;margin-top:3px;color:var(--muted);font-size:.8125rem}.record-reading-controls{display:flex;align-items:center;gap:8px}.record-reading-search{min-width:220px;height:36px;display:flex;align-items:center;gap:7px;border:1px solid var(--line);border-radius:9px;background:var(--card);padding:0 8px;color:var(--muted)}.record-reading-search :deep(svg){width:15px;height:15px}.record-reading-search input{min-width:0;flex:1;border:0;outline:0;background:transparent;font-size:0.8125rem}.record-reading-search button{width:24px;height:24px;border:0;border-radius:6px;background:transparent;color:var(--muted);cursor:pointer}.focus-button{min-height:36px;border:1px solid var(--line);border-radius:9px;background:var(--card);padding:0 10px;color:var(--text-2);font-weight:700;cursor:pointer}.record-reading-text{max-width:82ch;margin:0 auto;padding:clamp(26px,4vw,54px) clamp(24px,5vw,70px);white-space:pre-wrap;overflow-wrap:anywhere;color:var(--text);font:15.5px/1.82 Georgia,"Times New Roman",serif;outline:none}.record-reading-text:focus-visible{box-shadow:inset 0 0 0 3px color-mix(in srgb,var(--ui-accent,#3c8d62) 28%,transparent)}mark{color:inherit}.search-hit{background:var(--mark-bg);color:var(--mark-fg);border-radius:2px;padding:0 1px}.annotation-hit{color:var(--text);background:color-mix(in srgb,var(--ui-accent-soft,#eaf6ee) 74%,var(--tone-warn-bg));border-bottom:2px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 70%,var(--tone-warn-border));cursor:help}.annotation-hit:focus-visible{outline:3px solid var(--ui-accent-focus,#9fc8ad);outline-offset:2px;border-radius:2px}.focus-mode{position:fixed;inset:74px 32px 28px max(32px,var(--sidebar-width,250px));z-index:70;overflow:auto;box-shadow:0 24px 70px rgba(15,23,42,.22)}.focus-mode .record-reading-toolbar{position:sticky;top:0;z-index:2}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}.record-selection-popover{position:fixed;z-index:10020;display:flex;align-items:center;gap:6px;max-width:calc(100vw - 24px);padding:6px;border:1px solid var(--line);border-radius:10px;background:var(--card);box-shadow:0 14px 40px rgba(15,23,42,.2);font-size:.8125rem}.record-selection-popover>span{max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--muted)}.record-selection-popover button{min-height:32px;display:flex;align-items:center;gap:5px;border:0;border-radius:7px;background:var(--soft);padding:0 8px;color:var(--text-2);font-weight:700;cursor:pointer}.record-selection-popover button.primary{background:var(--ui-accent,#3c8d62);color:var(--accent-on)}.record-selection-popover :deep(svg){width:14px;height:14px}.record-annotation-tooltip{position:fixed;z-index:10040;max-height:min(320px,calc(100vh - 24px));overflow:auto;padding:11px;border:1px solid var(--line);border-radius:12px;background:var(--card);box-shadow:0 18px 48px rgba(15,23,42,.2);color:var(--text-2);font:12px/1.45 system-ui,sans-serif;pointer-events:none}.record-annotation-tooltip-head{display:flex;align-items:center;gap:7px;padding-bottom:7px;border-bottom:1px solid var(--line);color:var(--text-2)}.record-annotation-tooltip-head :deep(svg){width:15px;height:15px}.record-annotation-tooltip article{display:grid;gap:6px;padding:9px 1px;border-top:1px solid var(--line)}.record-annotation-tooltip article:first-of-type{border-top:0}.record-annotation-tooltip p{margin:0;white-space:pre-wrap;overflow-wrap:anywhere}.record-annotation-tooltip .annotation-no-note{color:var(--tone-info-fg);font-style:italic}.record-annotation-tooltip small{color:var(--muted)}.annotation-tooltip-tags{display:flex;flex-wrap:wrap;gap:5px}.annotation-tooltip-tags span{padding:2px 6px;border-radius:999px;background:var(--ui-accent-soft,#edf7f0);color: var(--accent-fg);font-size:.8125rem;font-weight:700}button:focus-visible,input:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--card));outline-offset:2px}
