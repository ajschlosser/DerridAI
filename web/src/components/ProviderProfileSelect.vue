...
<style scoped>
.provider-profile-select-component{display:grid;gap:11px;padding:14px;border:1px solid var(--line,#e2e8f0);border-radius:12px;background:linear-gradient(180deg,var(--card) 0%,var(--card) 100%);box-shadow:0 1px 2px rgba(15,23,42,.03)}
...
.provider-manage-button{flex:0 0 auto;border:0;background:transparent;color: var(--accent-fg);font-size:.8125rem;font-weight:750;padding:3px 0;cursor:pointer}.provider-manage-button:hover{text-decoration:underline}.provider-manage-button:focus-visible,.provider-select:focus-visible{outline:3px solid var(--accent);outline-offset:2px}
.provider-select-field{display:grid}.provider-select{width:100%;min-height:42px;font-size:.8125rem;font-weight:650;background:var(--card)}
