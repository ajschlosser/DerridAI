...
.provider-stat-group{display:flex;align-items:stretch;gap:7px}.provider-stat{min-width:76px;display:grid;align-content:center;gap:1px;padding:6px 8px;border:1px solid rgba(255,255,255,.85);border-radius:8px;background:color-mix(in srgb,var(--card) 68%,transparent);text-align:right}.provider-stat b{font-size:.8125rem}.provider-stat small{font-size:.8125rem;color:var(--muted,#64748b);line-height:1.25}
