...
<style scoped>
.build-readiness{position:sticky;bottom:12px;z-index:12;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center;padding:16px 18px;border:1px solid var(--line);border-radius:14px;background:var(--surface-glass,rgba(255,255,255,.96));box-shadow:0 14px 36px rgb(15 23 42 / .12);backdrop-filter:blur(10px)}
