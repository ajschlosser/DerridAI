...
const meta={title:"Corpus Builder/Review/Field Evidence List",component:FieldEvidenceList,args:{evidence,selectedField:"position_holder"}} satisfies Meta<typeof FieldEvidenceList>;
