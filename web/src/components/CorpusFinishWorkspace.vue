...
<style scoped>
.finish-workspace{display:grid;min-width:0;gap:16px;padding:18px;border:1px solid var(--line);border-radius:13px;background:var(--card)}.finish-head{display:flex;min-width:0;flex-wrap:wrap;justify-content:space-between;gap:22px;align-items:flex-start}.finish-head>div{min-width:0;flex:1 1 320px}.finish-head h2{margin:3px 0 6px;font-size:1.25rem}.finish-head p{margin:0;max-width:78ch;font-size:.8125rem;line-height:1.55;color:var(--muted)}.eyebrow{font-size:.8125rem;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);font-weight:800}.finish-primary{display:flex;min-width:0;flex:0 1 auto;align-items:center}.finish-primary .btn{max-width:100%;white-space:normal}.no-publishable{display:flex;justify-content:space-between;gap:18px;align-items:center;padding:16px;border:1px solid var(--tone-warn-edge);border-radius:11px;background:var(--tone-warn-bg)}.no-publishable h3{margin:3px 0 5px;font-size:1rem}.no-publishable p{margin:0;max-width:72ch;font-size:.875rem;line-height:1.5;color:var(--muted)}.document-blocker{display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap;padding:11px 13px;border:1px solid var(--tone-warn-edge);border-radius:9px;background:var(--tone-warn-bg);color:var(--tone-warn-fg);font-size:.8125rem}.document-blocker span{color:var(--muted)}.finish-grid{display:grid;min-width:0;grid-template-columns:repeat(auto-fit,minmax(min(240px,100%),1fr));gap:10px}.finish-card{display:grid;min-width:0;align-content:start;gap:9px;padding:14px;border:1px solid var(--line);border-radius:10px;background:var(--soft)}.finish-card[data-state="attention"]{background:var(--tone-warn-bg);border-color:var(--tone-warn-edge)}.finish-card[data-state="ready"],.finish-card[data-state="complete"]{background:var(--tone-ok-bg)}.card-state{font-size:.8125rem;text-transform:uppercase;letter-spacing:.07em;color:var(--muted);font-weight:800}.finish-card h3{margin:0;font-size:0.8125rem}.finish-card p{margin:0;font-size:.8125rem;line-height:1.48;color:var(--muted)}dl{display:grid;min-width:0;grid-template-columns:repeat(auto-fit,minmax(min(140px,100%),1fr));gap:7px;margin:0}dl div{padding-inline-start:8px;border-inline-start:2px solid var(--line)}dt{font-size:.8125rem;color:var(--muted)}dd{margin:2px 0 0;font-size:.8125rem;font-weight:800}.card-actions{display:flex;gap:7px;flex-wrap:wrap}.card-actions .btn{max-width:100%;white-space:normal;text-align:center}.link-action{justify-self:start;border:0;background:transparent;color: var(--accent-fg);padding:0;text-decoration:underline;font-size:.8125rem;cursor:pointer}.blockers{font-size:.8125rem}.blockers summary{cursor:pointer;font-weight:800}.blockers ul{margin:8px 0 0;padding:0;list-style:none;display:grid;gap:7px;color:var(--muted)}.blockers li{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 0;border-top:1px solid var(--line)}@media(max-width:760px){.finish-head{display:grid}.finish-grid{grid-template-columns:1fr}.finish-primary .btn{width:100%}}
</style>
