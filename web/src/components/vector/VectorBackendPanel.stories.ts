...
const meta = {title: "Vector Stores/Backend Panel", component: VectorBackendPanel, args: {health, probing: false, applying: false, probeResult: null, error: ""}} satisfies Meta<typeof VectorBackendPanel>;
export default meta;
