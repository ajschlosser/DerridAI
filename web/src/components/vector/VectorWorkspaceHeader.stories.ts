...
const meta = {title: "Corpus Data/Workspace Header", component: VectorWorkspaceHeader, args: {health, collectionCount: 2}} satisfies Meta<typeof VectorWorkspaceHeader>;
export default meta;
