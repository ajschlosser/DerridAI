...
<style scoped>
.metadata-issues{display:grid;gap:14px;padding:16px;border:1px solid #d9bf76;border-radius:12px;background:#fffaf0}.resolution-head{display:flex;justify-content:space-between;gap:20px;align-items:flex-start}.resolution-head h3{margin:2px 0 5px;font-size:16px}.resolution-head p{margin:0;max-width:76ch;font-size:10px;line-height:1.5;color:#5e4a12}.eyebrow,.path-kicker{font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:#7a651e;font-weight:800}.resolution-count{display:grid;text-align:end;min-width:90px}.resolution-count strong{font-size:24px;line-height:1}.resolution-count span{font-size:9px;color:var(--muted)}.operation{display:grid;grid-template-columns:minmax(0,1fr) minmax(160px,.45fr);gap:14px;align-items:center;padding:11px 12px;border-radius:9px;background:var(--card);border:1px solid var(--line)}.operation[data-state="failed"]{border-color:#c96b6b;background:#fff7f7}.operation-copy{display:grid;gap:3px}.operation-copy b{font-size:10px}.operation-copy span{font-size:9px;color:var(--muted);line-height:1.45}.operation progress{width:100%;height:8px}.resolution-paths{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.resolution-path{display:grid;align-content:start;gap:8px;padding:13px;border:1px solid rgba(94,74,18,.2);border-radius:10px;background:rgba(255,255,255,.58)}.resolution-path[data-empty="true"]{opacity:.78}.resolution-path h4{margin:0;font-size:12px}.resolution-path p{margin:0;font-size:9px;line-height:1.5;color:var(--muted)}.execution{display:flex;gap:13px;flex-wrap:wrap;font-size:8px;color:var(--muted)}.execution code{color:var(--text)}.resolution-path .btn{justify-self:start}.path-done{font-size:9px;color:var(--muted)}.issue-details{font-size:9px}.issue-details summary{cursor:pointer;font-weight:800}.issue-table{display:grid;margin-top:8px;border:1px solid var(--line);border-radius:9px;overflow:hidden}.issue-row{display:grid;grid-template-columns:minmax(130px,.8fr) minmax(120px,.7fr) minmax(220px,1.5fr) minmax(130px,.7fr);gap:10px;align-items:start;padding:8px 10px;border:0;border-bottom:1px solid var(--line);background:var(--card);color:inherit;text-align:start;font:inherit}.issue-row:not(.issue-header){cursor:pointer}.issue-row:not(.issue-header):hover{background:var(--soft)}.issue-row:last-child{border-bottom:0}.issue-header{font-weight:800;background:var(--soft)}.issue-row span{display:grid;gap:2px}.issue-row small{font-size:8px;color:var(--muted);line-height:1.35}@media(max-width:800px){.resolution-head{display:grid}.resolution-count{text-align:start}.resolution-paths{grid-template-columns:1fr}.operation{grid-template-columns:1fr}.issue-row{grid-template-columns:1fr 1fr}.issue-header{display:none}}
</style>
