...
export const Empty: Story = {args: {modelValue: "xyzzy", results: [], resultCount: "0 matching settings"}};
export const French: Story = {
  ...
  args: {
    ...
    results: [
      {id: "rag-k", section: "retrieval", label: "k de repérage", group: "Magasins vectoriels et repérage"},
    ],
  },
};
