...
const meta={title:"Feedback/Accessible Empty State",component:AccessibleEmptyState,args:{title:"No records yet",description:"Choose a work or change the search filters.",actionLabel:"Browse works",icon:"books"}} satisfies Meta<typeof AccessibleEmptyState>;export default meta;type Story=StoryObj<typeof meta>;export const Default:Story={};
