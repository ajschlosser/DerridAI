...
export const DatabaseRequired: Story = { args: { title: "Research needs a corpus database", description: "Create a vector collection from your loaded works, then return here to ask evidence-grounded questions.", actionLabel: "Create a collection", icon: "database" } };
export const DatabaseRequiredWithoutAccess: Story = { args: { title: "Research needs a corpus database", description: "Ask an administrator to configure a corpus database or grant you access.", actionLabel: "", icon: "database" } };
