...
export const SegmentationBlocked:Story={args:{status:"blocked",stage:"segmentation_review",progress:.4,recordCount:0,reviewCount:0,acceptedCount:0,unresolvedCount:7,warnings:["No record set was constructed because required semantic transitions remain unresolved."],validation:null,llmMetrics:{calls:39,retries:18,structured_output_failures:18,escalations:2}}};
