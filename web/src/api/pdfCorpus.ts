...
export interface EnrichmentMetrics {
  self_consistency?:Interval;models:Record<string,EnrichmentModelMetrics>;inter_model_agreement:{compared:number;agreement:number|null};unresolved_remaining:number|null;
