...
export const pdfCorpusApi = {
  ...
  updateDocumentLayout: (assetId: string, plan: DocumentLayoutPlan) =>
    apiRequest<PdfAsset>(`/api/pdf/assets/${encodeURIComponent(assetId)}/document-layout`, {
      method: "PATCH",
      body: JSON.stringify(plan),
    }),
  blocks: (assetId: string, offset = 0, limit = 200, ids: string[] = []) =>
    apiRequest<{ items: SourceBlock[]; total: number }>(
      `/api/pdf/assets/${encodeURIComponent(assetId)}/blocks?offset=${offset}&limit=${limit}${ids.length ? `&ids=${encodeURIComponent(ids.join(","))}` : ""}`,
    ),
  ...
  listBuilds: (offset = 0, limit = 50, assetId = "") =>
    apiRequest<{ items: CorpusBuild[]; total: number; offset: number; limit: number }>(
      `/api/pdf/corpus-builds?offset=${offset}&limit=${limit}${assetId ? `&asset_id=${encodeURIComponent(assetId)}` : ""}`,
    ),
  build: (buildId: string) =>
    apiRequest<CorpusBuild>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}`),
  runAutonomous: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/autonomous/run`,
      { method: "POST", body: JSON.stringify(payload) },
    ),
  regenerateManifest: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<{ build: CorpusBuild; filled: string[] }>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/manifest/regenerate`,
      { method: "POST", body: JSON.stringify(payload) },
    ),
  patchManifest: (buildId: string, changes: Record<string, unknown>, expectedRevision?: number) =>
    apiRequest<CorpusBuild>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/manifest`, {
      method: "PATCH",
  ...
  switchProviderProfile: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/provider-profile`,
      { method: "PATCH", body: JSON.stringify(payload) },
    ),
  createBuild: (payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>("/api/pdf/corpus-builds", {
      method: "POST",
  ...
  markViewed: (buildId: string, recordId: string) =>
    apiRequest<{ record_id: string; activity: CorpusRecord["activity"] }>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/viewed`,
      { method: "POST" },
    ),
  accept: (buildId: string, recordId: string, accepted = true, expectedRevision?: number) =>
    apiRequest<CorpusRecord>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/accept`,
  ...
  disposition: (
    ...
    apiRequest<CorpusRecord>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/disposition`,
      {
        method: "POST",
  ...
  reviewDecision: (
    ...
    apiRequest<{
      ...
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/review-decision`,
      {
        method: "POST",
        body: JSON.stringify({
          disposition,
  ...
  metadataDecision: (
    ...
    apiRequest<{
      ...
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/metadata-decision`,
      {
        method: "POST",
        body: JSON.stringify({
          field,
  ...
  bulkDisposition: (
    ...
    apiRequest<{
      ...
      queue_counts?: CorpusBuild["review_queue_counts"];
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/disposition`, {
      method: "POST",
      body: JSON.stringify({
        disposition,
        reason,
  ...
  bulkMetadata: (
    ...
    apiRequest<{
      ...
      record_ids: string[];
      queue_counts?: CorpusBuild["review_queue_counts"];
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/metadata`, {
      method: "PATCH",
      body: JSON.stringify({
        changes,
  ...
  undoReview: (buildId: string) =>
    apiRequest<{
      ...
      can_undo?: boolean;
      can_redo?: boolean;
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/review/undo`, { method: "POST" }),
  redoReview: (buildId: string) =>
    apiRequest<{
      ...
      can_undo?: boolean;
      can_redo?: boolean;
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/review/redo`, { method: "POST" }),
  sliceRecord: (
    buildId: string,
    recordId: string,
    ...
    apiRequest<{
      ...
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/slice`,
      {
        method: "POST",
        body: JSON.stringify({
          direction,
  ...
  adjudicateBoundary: (
    ...
    apiRequest<{
      ...
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/boundary-adjudication`,
  ...
  patchText: (
    ...
    apiRequest<CorpusRecord>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/text`,
      {
        method: "PATCH",
        body: JSON.stringify({
          text,
  ...
  patchEvidence: (
    ...
    apiRequest<CorpusRecord>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/evidence`,
      {
        method: "PATCH",
        body: JSON.stringify({
          field,
  ...
  merge: (
    ...
    apiRequest<CorpusRecord>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/merge`,
  ...
  split: (buildId: string, recordId: string, afterBlockId: string, expectedRevision?: number) =>
    apiRequest<{ records: CorpusRecord[] }>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/split`,
      {
        method: "POST",
  ...
  retryMetadata: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/metadata/retry`,
      { method: "POST", body: JSON.stringify(payload) },
    ),
  ...
  enrichmentMetrics: (buildId: string) =>
    apiRequest<EnrichmentMetrics>(
      `/api/pdf/corpus-enrichment-metrics?build_id=${encodeURIComponent(buildId)}`,
    ),
  rerunMetadataEnrichment: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/metadata/enrich`,
      { method: "POST", body: JSON.stringify(payload) },
    ),
  editorialMemory: (buildId: string) =>
    ...
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/editorial-memory`),
  ...
  previewRecord: (buildId: string, recordId: string) =>
    apiRequest<{
      ...
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/records/${encodeURIComponent(recordId)}/preview`,
    ),
  ...
  confirmManifest: (buildId: string, payload: Record<string, unknown>) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/confirm-manifest`,
      { method: "POST", body: JSON.stringify(payload) },
    ),
  cancel: (buildId: string) =>
    apiRequest<CorpusBuild>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/cancel`, {
      method: "POST",
    }),
  settleMetadata: (buildId: string) =>
    apiRequest<CorpusBuild>(
      `/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/settle-metadata`,
      { method: "POST" },
    ),
  ...
  publish: (buildId: string) =>
    apiRequest<{
      ...
      record_count: number;
      created_at: string;
    }>(`/api/pdf/corpus-builds/${encodeURIComponent(buildId)}/publish`, {
      method: "POST",
      body: JSON.stringify({ require_acceptance: true }),
    }),
  publicationUrl: (publicationId: string) =>
    `/api/pdf/publications/${encodeURIComponent(publicationId)}/download`,
};
