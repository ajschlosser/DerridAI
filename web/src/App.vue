...
<template>
  ...
  <div v-else class="app-shell v030-shell" :class="{'sidebar-collapsed':s.sidebarCollapsed}">
    ...
    <section class="workspace v030-workspace">
      ...
      <footer class="app-footer">© 2026 The New England Transcendentalist Club of California · DerridAI 0.35.17</footer>
    </section>
  </div>
