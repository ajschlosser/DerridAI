...
export function useCorpusBuildLifecycle(
  currentBuild: Ref<CorpusBuild|null>, recordTotal: Ref<number>, reviewQueue: Ref<ReviewQueue>,
) {
  ...
  return { reviewQueueCounts, reviewRemaining, pendingCount, issueCount, readyCount, topologyIssueCount, buildRunning, reviewLocked, structuralReviewLocked, canResume, segmentationNeedsReview, retryingSegmentation, canRetryMetadata, metadataIssueCount, metadataFieldIssueCount, metadataRetryRunning, awaitingManifestReview, hasRecordTopology, showBuildConfiguration, reviewComplete, finishPhase, showReviewWorkspace };
}
