    ...
    <template v-else-if="snapshot">
      ...
      <section class="search-explorer-grid">
        ...
        <section class="search-results-panel" aria-labelledby="search-results-title">
          ...
          <div v-else class="search-table-scroll ui-table-scroll" tabindex="0" role="region" :aria-label="i18n.t('search.results_table_scroll','Search results table. Scroll horizontally to reveal additional columns.')">
