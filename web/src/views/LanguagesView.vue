        ...
        <template v-else-if="current">
          ...
          <section class="language-policy-card" :aria-label="i18n.t('language.content_policy_title','Researcher text policy')">
            ...
            <div v-if="policyReady" class="language-policy-terms">
              ...
              <p v-if="contentPolicy?.contextual_terms?.length" class="language-policy-contextual">{{ i18n.t("language.content_policy_contextual", "Context-sensitive terms") }} · {{ i18n.t("language.content_policy_contextual_help", "These tokens are blocked except when the listed scholarly or naming exemptions apply.") }}</p>
            </div>
          </section>
