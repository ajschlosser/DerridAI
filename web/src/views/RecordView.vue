...
<style scoped>
.record-workspace-page{display:grid;gap:12px;padding:16px 18px 28px;max-width:1600px;margin:0 auto}.record-workspace-loading,.record-workspace-empty{min-height:360px;display:grid;place-items:center;align-content:center;gap:12px;text-align:center}.record-workspace-loading span{width:34px;height:34px;border:3px solid var(--line);border-top-color:var(--ui-accent,#3c8d62);border-radius:50%;animation:record-spin .8s linear infinite}.record-workspace-empty h1{margin:0;font:600 26px/1.2 Georgia,"Times New Roman",serif}.record-workspace-empty p{max-width:600px;margin:0;color:var(--muted);line-height:1.55}.record-workspace-empty>div{display:flex;gap:8px}.record-workspace-empty button{min-height:38px;border:1px solid var(--line);border-radius:9px;background:var(--card);padding:0 12px;color:var(--text-2);font-weight:800;cursor:pointer}.record-context-strip{min-height:38px;display:flex;align-items:center;gap:7px;flex-wrap:wrap;padding:0 4px}.record-context-badge,.record-context-link{display:inline-flex;width:auto;max-width:100%;min-height:28px;align-items:center;border:1px solid var(--line);border-radius:999px;background:var(--card);padding:4px 9px;color:var(--text-2);font-size:.8125rem;font-weight:750;white-space:normal;overflow-wrap:anywhere}.record-context-badge.warn{border-color:var(--tone-warn-edge);background:var(--tone-warn-bg);color:var(--tone-warn-fg)}.record-context-link{cursor:pointer}.record-context-spacer{flex:1}.record-inspector-toggle{min-height:30px;border:0;background:transparent;padding:0 6px;color:var(--text-2);font-size:.8125rem;font-weight:800;cursor:pointer}.record-workspace-grid{position:relative;display:grid;grid-template-columns:minmax(0,1fr) 6px minmax(310px,var(--record-inspector-width,360px));gap:12px;align-items:start;min-width:0}.record-workspace-grid.inspector-collapsed{grid-template-columns:minmax(0,1fr)}.record-inspector-resizer{align-self:stretch;width:6px;min-height:460px;border:0;border-radius:999px;background:transparent;cursor:col-resize;position:relative}.record-inspector-resizer:after{content:"";position:absolute;left:3px;top:36px;bottom:36px;width:2px;border-radius:2px;background:var(--soft)}.record-inspector-resizer:hover:after,.record-inspector-resizer:focus-visible:after{background:var(--ui-accent,#3c8d62)}.record-inspector-resizer:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--card));outline-offset:1px}.record-annotation-dialog{width:min(560px,calc(100vw - 32px));max-width:none;border:0;border-radius:16px;padding:0;background:var(--card);box-shadow:0 24px 80px rgba(15,23,42,.22)}.record-annotation-dialog::backdrop{background:rgba(15,23,42,.38);backdrop-filter:blur(2px)}.record-annotation-dialog header{display:flex;justify-content:space-between;gap:14px;align-items:start;padding:18px 20px;border-bottom:1px solid var(--line)}.record-annotation-dialog header p{margin:0;color:var(--tone-ok-fg);font-size:.8125rem;font-weight:800;text-transform:uppercase;letter-spacing:.07em}.record-annotation-dialog h2{margin:3px 0 0;font:600 21px/1.2 Georgia,"Times New Roman",serif}.record-annotation-dialog header button{width:36px;height:36px;border:1px solid var(--line);border-radius:9px;background:var(--card);font-size:1.25rem;cursor:pointer}.record-annotation-form{display:grid;gap:14px;padding:18px 20px}.record-annotation-form blockquote{margin:0;padding:11px 12px;border-left:3px solid var(--ui-accent,#3c8d62);border-radius:0 8px 8px 0;background:var(--card);color:var(--text-2);font:13px/1.55 Georgia,"Times New Roman",serif}.record-annotation-form label{display:grid;gap:6px}.record-annotation-form label span{color:var(--text-2);font-size:.8125rem;font-weight:800}.record-annotation-form textarea,.record-annotation-form input{width:100%;border:1px solid var(--line);border-radius:9px;padding:9px 10px;font:13px/1.45 system-ui,sans-serif}.record-annotation-form textarea{resize:vertical}.record-annotation-error{margin:0;padding:9px 10px;border-radius:8px;background:var(--tone-danger-bg);color:var(--tone-danger-fg);font-size:.8125rem}.record-annotation-dialog footer{display:flex;justify-content:flex-end;gap:8px;padding:13px 20px;border-top:1px solid var(--line);background:var(--card)}.record-annotation-dialog footer button{min-height:38px;border:1px solid var(--line);border-radius:9px;background:var(--card);padding:0 12px;color:var(--text-2);font-weight:800;cursor:pointer}.record-annotation-dialog footer .primary{border-color:var(--ui-accent,#3c8d62);background:var(--ui-accent,#3c8d62);color:var(--accent-on)}button:focus-visible,textarea:focus-visible,input:focus-visible{outline:3px solid color-mix(in srgb,var(--ui-accent,#3c8d62) 42%,var(--card));outline-offset:2px}@keyframes record-spin{to{transform:rotate(360deg)}}@media(max-width:1180px){.record-workspace-page{padding:12px 14px 26px}.record-workspace-grid{grid-template-columns:1fr;gap:14px}.record-inspector-resizer{display:none}}@media(max-width:640px){.record-workspace-page{padding:10px 9px 24px}}@media(prefers-reduced-motion:reduce){.record-workspace-loading span{animation:none}}
</style>
