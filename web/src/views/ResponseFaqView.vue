...
function gradeOverall(entry:Record<string,unknown>){const grade=(entry.result&&typeof entry.result==="object"?entry.result:entry) as Record<string,unknown>;return grade.overall??grade.score??"—"}
...
<style scoped>
.response-faq-page{max-width:1540px!important;display:grid;gap:16px;padding-bottom:38px}.response-faq-intro{align-items:center}.response-faq-page-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap;justify-content:flex-end}.response-faq-page-actions .btn{min-height:40px;display:inline-flex;align-items:center;gap:7px}.response-faq-page-actions .btn svg{width:15px;height:15px}.response-faq-page-actions .btn>span{min-width:22px;height:22px;display:grid;place-items:center;border-radius:999px;background:#edf2ef;font-size:10px}.response-faq-loading{min-height:260px;border:1px solid #e2e8ed;border-radius:16px;background:#fff}.response-faq-workspace{display:grid;gap:14px;min-width:0}.response-faq-instructions{display:grid;grid-template-columns:28px minmax(0,1fr);gap:10px;align-items:start;margin:0;padding:10px 12px;border:1px solid #e2e8e4;border-radius:11px;background:#fafcfb;color:#617087}.response-faq-instructions>svg{width:17px;height:17px;margin-top:2px;color:#678173}.response-faq-instructions div{display:grid;gap:2px}.response-faq-instructions strong{color:#405267;font-size:11px;text-transform:uppercase;letter-spacing:.05em}.response-faq-instructions p{margin:0;font-size:12.5px;line-height:1.5}.response-faq-workspace :deep(.research-answer-workspace),.response-faq-workspace :deep(.research-evidence-panel){box-shadow:0 10px 30px rgba(15,23,42,.045)}.response-faq-details{overflow:hidden;border:1px solid #dfe6ec;border-radius:14px;background:#fff}.response-faq-details>summary{min-height:64px;display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;padding:11px 14px;list-style:none;cursor:pointer;background:#fbfcfd}.response-faq-details>summary::-webkit-details-marker{display:none}.response-faq-details>summary>span{width:32px;height:32px;display:grid;place-items:center;border-radius:9px;background:var(--ui-accent-soft);color:var(--ui-accent-dark)}.response-faq-details>summary svg{width:16px;height:16px}.response-faq-details>summary>div{display:grid;gap:2px}.response-faq-details>summary strong{color:#304158;font-size:13.5px}.response-faq-details>summary small{color:#728095;font-size:11.5px;line-height:1.4}.response-faq-details>summary>b{color:#7d8999;font-size:17px;transition:transform .16s ease}.response-faq-details[open]>summary{border-bottom:1px solid #e6ebef}.response-faq-details[open]>summary>b{transform:rotate(180deg)}.response-faq-details-body{display:grid;gap:18px;padding:17px}.response-faq-run-summary,.response-faq-metadata-section,.response-faq-grades{display:grid;gap:10px}.response-faq-details-body header{display:grid;gap:3px}.response-faq-details-body h2{margin:0;color:#304158;font-size:14px}.response-faq-details-body header p{margin:0;color:#748296;font-size:11.5px;line-height:1.45}.response-faq-metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(135px,1fr));gap:8px}.response-faq-metrics article{display:grid;gap:4px;padding:11px 12px;border:1px solid #e2e8ed;border-radius:10px;background:#fbfcfd}.response-faq-metrics span{color:#748196;font-size:10.5px;font-weight:750;text-transform:uppercase;letter-spacing:.04em}.response-faq-metrics strong{color:#26384f;font-size:18px;font-variant-numeric:tabular-nums}.response-faq-detail-columns{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.response-faq-metadata-section dl{display:grid;margin:0;border:1px solid #e3e8ed;border-radius:10px;overflow:hidden}.response-faq-metadata-section dl>div{display:grid;grid-template-columns:minmax(120px,.72fr) minmax(0,1fr);gap:9px;padding:8px 10px;border-top:1px solid #edf0f3}.response-faq-metadata-section dl>div:first-child{border-top:0}.response-faq-metadata-section dt{color:#728095;font-size:11px}.response-faq-metadata-section dd{margin:0;color:#34455c;font-size:11.5px;font-weight:700;overflow-wrap:anywhere}.response-faq-grades>div{display:grid;gap:7px}.response-faq-grades article{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;padding:10px 12px;border:1px solid #e3e8ed;border-radius:10px;background:#fbfcfd}.response-faq-grades article>span{display:grid;gap:2px}.response-faq-grades article>span small{color:#718096;font-size:11px}.response-faq-grades article>strong{color:var(--ui-accent-dark);font-size:18px}.response-faq-grades article>strong small{font-size:10px;color:#758397}.response-faq-grade-output{grid-column:1/-1;border-top:1px solid #e6ebef;padding-top:6px}.response-faq-grade-output>summary{width:max-content;max-width:100%;min-height:32px;display:flex;align-items:center;color:#5f7085;font-size:10.5px;font-weight:750;cursor:pointer}.response-faq-grade-output pre{max-height:340px;margin:4px 0 0;padding:10px;overflow:auto;border:1px solid #e2e8ed;border-radius:8px;background:#fff;white-space:pre-wrap;overflow-wrap:anywhere;color:#43556b;font:10.5px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace}.response-faq-technical{border-top:1px solid #e8edf1;padding-top:4px}.response-faq-technical>summary{width:max-content;max-width:100%;min-height:34px;display:flex;align-items:center;color:#65758a;font-size:11.5px;font-weight:750;cursor:pointer}.response-faq-technical>div{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding-top:8px}.response-faq-technical section{min-width:0;padding:10px;border:1px solid #e4e9ee;border-radius:9px;background:#f9fbfc}.response-faq-technical h3{margin:0 0 7px;color:#415168;font-size:11.5px}.response-faq-technical pre{max-height:260px;margin:0;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;color:#4b5c70;font:10.5px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace}.response-faq-page :is(button,input,summary):focus-visible{outline:3px solid var(--ui-accent-focus);outline-offset:2px}@media(max-width:900px){.response-faq-detail-columns,.response-faq-technical>div{grid-template-columns:1fr}}@media(max-width:700px){.response-faq-intro{align-items:flex-start}.response-faq-page-actions{width:100%;justify-content:stretch}.response-faq-page-actions .btn{flex:1;justify-content:center}.response-faq-details>summary small{display:none}.response-faq-details-body{padding:12px}.response-faq-metadata-section dl>div{grid-template-columns:1fr;gap:3px}}@media(max-width:500px){.response-faq-page-actions{display:grid;grid-template-columns:1fr}.response-faq-metrics{grid-template-columns:1fr 1fr}}@media(prefers-reduced-motion:reduce){.response-faq-page *{scroll-behavior:auto!important;transition:none!important}}
</style>
