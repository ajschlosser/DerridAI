    ...
    >
      <template #actions>
        <div class="response-faq-page-actions">
          <button v-if="payload && cacheTotal" class="btn" type="button" @click="archiveOpen = true">
            <AppIcon name="search" />
...
<style scoped>
.response-faq-page{display:grid;gap:var(--page-gap)}.response-faq-page-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap;justify-content:flex-end}.response-faq-page-actions .btn{min-height:40px;display:inline-flex;align-items:center;gap:7px}.response-faq-page-actions .btn svg{width:15px;height:15px}.response-faq-page-actions .btn>span{min-width:22px;height:22px;display:grid;place-items:center;border-radius:999px;background:var(--soft);font-size:.8125rem}.response-faq-loading{min-height:260px;border:1px solid var(--line);border-radius:16px;background:var(--card)}.response-faq-workspace{display:grid;gap:14px;min-width:0}.response-faq-instructions{display:grid;grid-template-columns:28px minmax(0,1fr);gap:10px;align-items:start;margin:0;padding:10px 12px;border:1px solid var(--line);border-radius:11px;background:var(--card);color:var(--muted)}.response-faq-instructions>svg{width:17px;height:17px;margin-top:2px;color:var(--muted)}.response-faq-instructions div{display:grid;gap:2px}.response-faq-instructions strong{color:var(--text-2);font-size:.8125rem;text-transform:uppercase;letter-spacing:.05em}.response-faq-instructions p{margin:0;font-size:0.78125rem;line-height:1.5}.response-faq-workspace :deep(.research-answer-workspace),.response-faq-workspace :deep(.research-evidence-panel){box-shadow:0 10px 30px rgba(15,23,42,.045)}.response-faq-details{overflow:hidden;border:1px solid var(--line);border-radius:14px;background:var(--card)}.response-faq-details>summary{min-height:64px;display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;padding:11px 14px;list-style:none;cursor:pointer;background:var(--card)}.response-faq-details>summary::-webkit-details-marker{display:none}.response-faq-details>summary>span{width:32px;height:32px;display:grid;place-items:center;border-radius:9px;background:var(--ui-accent-soft);color:var(--accent-fg)}.response-faq-details>summary svg{width:16px;height:16px}.response-faq-details>summary>div{display:grid;gap:2px}.response-faq-details>summary strong{color:var(--text-2);font-size:0.84375rem}.response-faq-details>summary small{color:var(--muted);font-size:.8125rem;line-height:1.4}.response-faq-details>summary>b{color:var(--muted);font-size:1.0625rem;transition:transform .16s ease}.response-faq-details[open]>summary{border-bottom:1px solid var(--line)}.response-faq-details[open]>summary>b{transform:rotate(180deg)}.response-faq-details-body{display:grid;gap:18px;padding:17px}.response-faq-run-summary,.response-faq-metadata-section,.response-faq-grades{display:grid;gap:10px}.response-faq-details-body header{display:grid;gap:3px}.response-faq-details-body h2{margin:0;color:var(--text-2);font-size:0.875rem}.response-faq-details-body header p{margin:0;color:var(--muted);font-size:.8125rem;line-height:1.45}.response-faq-metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(135px,1fr));gap:8px}.response-faq-metrics article{display:grid;gap:4px;padding:11px 12px;border:1px solid var(--line);border-radius:10px;background:var(--card)}.response-faq-metrics span{color:var(--muted);font-size:.8125rem;font-weight:750;text-transform:uppercase;letter-spacing:.04em}.response-faq-metrics strong{color:var(--text-2);font-size:1.125rem;font-variant-numeric:tabular-nums}.response-faq-detail-columns{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.response-faq-metadata-section dl{display:grid;margin:0;border:1px solid var(--line);border-radius:10px;overflow:hidden}.response-faq-metadata-section dl>div{display:grid;grid-template-columns:minmax(120px,.72fr) minmax(0,1fr);gap:9px;padding:8px 10px;border-top:1px solid var(--line)}.response-faq-metadata-section dl>div:first-child{border-top:0}.response-faq-metadata-section dt{color:var(--muted);font-size:.8125rem}.response-faq-metadata-section dd{margin:0;color:var(--text-2);font-size:.8125rem;font-weight:700;overflow-wrap:anywhere}.response-faq-grades>div{display:grid;gap:7px}.response-faq-grades article{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;padding:10px 12px;border:1px solid var(--line);border-radius:10px;background:var(--card)}.response-faq-grades article>span{display:grid;gap:2px}.response-faq-grades article>span small{color:var(--muted);font-size:.8125rem}.response-faq-grades article>strong{color:var(--accent-fg);font-size:1.125rem}.response-faq-grades article>strong small{font-size:.8125rem;color:var(--muted)}.response-faq-grade-output{grid-column:1/-1;border-top:1px solid var(--line);padding-top:6px}.response-faq-grade-output>summary{width:max-content;max-width:100%;min-height:32px;display:flex;align-items:center;color:var(--muted);font-size:.8125rem;font-weight:750;cursor:pointer}.response-faq-grade-output :deep(.evaluation-report){margin-top:8px}.response-faq-technical{border-top:1px solid var(--line);padding-top:4px}.response-faq-technical>summary{width:max-content;max-width:100%;min-height:34px;display:flex;align-items:center;color:var(--muted);font-size:.8125rem;font-weight:750;cursor:pointer}.response-faq-technical>div{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding-top:8px}.response-faq-technical section{min-width:0;padding:10px;border:1px solid var(--line);border-radius:9px;background:var(--card)}.response-faq-technical h3{margin:0 0 7px;color:var(--text-2);font-size:.8125rem}.response-faq-technical pre{max-height:260px;margin:0;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;color:var(--text-2);font:12px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace}.response-faq-page :is(button,input,summary):focus-visible{outline:3px solid var(--ui-accent-focus);outline-offset:2px}@media(max-width:900px){.response-faq-detail-columns,.response-faq-technical>div{grid-template-columns:1fr}}@media(max-width:700px){.response-faq-page-actions{width:100%;justify-content:stretch}.response-faq-page-actions .btn{flex:1;justify-content:center}.response-faq-details>summary small{display:none}.response-faq-details-body{padding:12px}.response-faq-metadata-section dl>div{grid-template-columns:1fr;gap:3px}}@media(max-width:500px){.response-faq-page-actions{display:grid;grid-template-columns:1fr}.response-faq-metrics{grid-template-columns:1fr 1fr}}@media(prefers-reduced-motion:reduce){.response-faq-page *{scroll-behavior:auto!important;transition:none!important}}
</style>
